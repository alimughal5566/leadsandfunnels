@php
      ...
      $contact_arr['Funnel Name'] = $funnelName;
            ...
            <div class="modal-header">
                ...
                <div class="col__wrapper lead__options border-0 p-0 h-auto">
                        ...
                        <div class="lead__action">
                            <ul class="action__list">
                                <li class="action__item">
                                    <a  href="{{ LP_BASE_URL.LP_PATH.'/export/exportsworddata?u='.$unique_key.'&client_id='.$client_id.'&funnel_url=' . $funnelURL.'&funnel_name='.$funnelName }}" class="action__link">
                                        <span class="ico ico-ms-word"></span>export as .doc
                                    </a>
                                </li>
                                <li class="action__item">
                                    <a href="{{ LP_BASE_URL.LP_PATH.'/export/exportsexcelddata?u='.$unique_key.'&client_id='.$client_id.'&funnel_url=' . $funnelURL.'&funnel_name='.$funnelName }}" class="action__link">
                                        <span class="ico ico-adobe-xs"></span>export excel
                                    </a>
                                </li>
                                <li class="action__item">
                                    <a href="{{ LP_BASE_URL.LP_PATH.'/export/exportspdfdata?u='.$unique_key.'&client_id='.$client_id.'&funnel_url=' . $funnelURL.'&funnel_name='.$funnelName }}" class="action__link">
                                        <span class="ico ico-adobe"></span>export as pdf
                                    </a>
                                </li>
                                <li class="action__item">
                                    <a href="javascript:void(0);" id="printmailtopophref" data-uniquekey="{{$unique_key}}" class="action__link">
                                        <span class="ico ico-print"></span>print
                                    </a>
                                </li>
                                <li class="action__item">
                                    <a href="javascript:void(0);" id="mailtopophref" data-uniquekey="{{$unique_key}}" class="action__link">
                    ...
                    <div class="col-right">
                        <ul class="action__list">
                            <li class="action__item">
                                <a href="#" data-dismiss="modal" id="delmyleads" class="action__link lead__btn-del" data-uniquekey="{{ $unique_key }}">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="lead-modal-des">
                                    ...
                                    $qindex = 'q'.$i;
                                    if($lead[$qindex] != "") {
                                    $question = str_replace(":","",rtrim($lead[$qindex]));
                                    $aindex = 'a'.$i;
                                    $answer = $lead[$aindex];

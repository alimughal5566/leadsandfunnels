@foreach ($overlaydata as $vdata)
    ...
    <div id="{{ $id }}" class="{{ $ol_class }} overlay_container">
        ...
        <div class="helper_overlay">
            ...
            <a href="#" data-ov-target="{{ $ol_class }}" class="libaray-close close_btn cl-ovl-pop" id="close_btn"><i class="glyphicon glyphicon-remove ico-cross lp-ho-cls"></i></a>
            <div class="container">

                <div class="header">
                    <div class="row lp-ov-logo">
                        <div class="col text-center">
                            <img src="{{ config('view.rackspace_default_images') }}/ovlogo.png" alt="" class="iconimage">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-4">
                ...
                <div id="msgNote" class="modal msgNote" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content-wrap">
                            <a href="#" data-dismiss="modal" class="close_btn cl-ovl-pop note_msg" id="close_btn"><i class="glyphicon glyphicon-remove ico-cross lp-ho-cls"></i></a>
                            ...
                            <div class="modal-body">
                                <p class="msgNote__p">
                                    ...
                                    --<br/><br/>
                                    Sincerely,<br/><br/>
                                    <img src="{{ config('view.rackspace_default_images') }}/sign.png" width="25%" alt="" class="iconimage"><br/>
                                    leadPops.com<br/>
                                    Co-Founder & CEO
                                </p>
                            ...
                            <div class="row cta-desc">
                                <div class="col-md-12 text-center">
                                    @if( (env('APP_ENV') != config('app.env_production')) )
                                        <a href="{{ str_replace("https://myleads.leadpops.com", env('APP_URL') , $cta["cta_url"]) }}" class="leadpops_helper_btn text-center" target="{{ $cta["cta_target"] }}">{{ $cta["cta_name"] }}</a>
                                    @else
        ...
        <div class="helper_popup d-none">
            <div class="helper_popup_border">
                <div class="helper_popup_content">
                    <a href="#" data-ov-target="{{ $ol_class }}" class="close_btn v_2 cl-ovl-pop track-close"><i class="glyphicon ico-cross glyphicon-remove lp-ho-cls"></i></a>
...
<link rel="stylesheet" href="{{ config('view.theme_assets').'/css/msg-note.css?v='.LP_VERSION }}">
<link rel="stylesheet" href="{{ config('view.theme_assets').'/css/leadpops_helper.css?v='.LP_VERSION }}">
<script src="{{ config('view.theme_assets').'/js/leadpops_helper.js?v='.LP_VERSION }}"></script>

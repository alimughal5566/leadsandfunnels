...
@section('content')
    @php
       ...
       $footerLinkTitle = empty($view->data->bottomlinks['about_text']) ? "About Us" : $view->data->bottomlinks['about_text'];
    ...
    <main class="main" data-global="{{ @$view->data->globalOptions['about_type']}}" data-single="{{ @$view->data->bottomlinks['about_type']}}">
        ...
        <!-- Title wrap of the page -->
            ...
            <form id="pricay-page" enctype="multipart/form-data" name="ffooter" id="ffooter" method="POST"
                ...
                <input type="hidden" name="lpkey_aboutus" id="lpkey_aboutus" value="">
                <input type="hidden" name="theselectiontype" id="theselectiontype" value="aboutus">
                <input type="hidden" name="about_us_active" id="about_us_active" value="{{  @$view->data->bottomlinks['about_active']  }}">
                <input type="hidden" name="gfot_ai_val" id="gfot_ai_val" value="{{  @$view->data->globalOptions['about_us_active']  }}">
                <input type="hidden" name="thelink" id="thelink"  value="about_active">
                                ...
                                <ul class="action__list">
                                    <li class="action__item">
                                        ...
                                        <input @php echo $checked; @endphp id="fp-privacy-policy"
                                               ...
                                               data-field = 'about_us_active'
                                               class="pptogbtn global-switch gfooter-toggle"
                                               data-lpkeys="@php echo @$view->data->lpkeys."~about_active"; @endphp"
                                ...
                                <div class="input__wrapper">
                                    <div class="select2js__linkpage-option-parent">
                                        <select class="select2js__linkpage-option global-select"
                                                data-global_val="{{@$view->data->globalOptions['about_type']}}"
                                                data-val="{{@$view->data->bottomlinks['about_type']}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input__wrapper">
                                    <input id="theurltext" name="theurltext" class="form-control global-input-text"
                                           data-global_val="{{ @$view->data->globalOptions['about_text'] }}"
                                           data-val="@php echo @$view->data->bottomlinks['about_text'];  @endphp"
                                           type="text"
                                           value="@php echo @$view->data->bottomlinks['about_text'];  @endphp" data-form-field>
                                </div>
                            </div>
                        </div>
                        <div class="content__wrapper">
                            <div class="own-web" id="webmodal" style=" @php echo (@$view->data->bottomlinks['about_type']=='m'?'display:block':'display:none') @endphp;">
                                <div class="classic-editor__wrapper froala-editor-full-width froala-editor-fixed-width funnel-setting-pages-editor">
                                    <textarea name="footereditor"
                                        ...
                                        @php echo @$view->data->bottomlinks['about']; @endphp</textarea>
                                </div>
                            </div>
                                    ...
                                    <div class="col-10 pl-2">
                                        <div class="input__wrapper">
                                            <input id="theurl" name="theurl" class="form-control global-input-text"
                                                   data-global_val="{{ @$view->data->globalOptions['about_url'] }}"
                                                   data-val="@php echo @$view->data->bottomlinks['about_url'];@endphp"
                                                   value="@php echo @$view->data->bottomlinks['about_url'];@endphp"
            ...
            <div id="text-area-content" style="display: none">@php echo htmlspecialchars_decode(@$view->data->bottomlinks['about']) @endphp</div>
            <div id="text-area-content-global" style="display: none">{!! @$view->data->globalOptions['about'] !!}</div>


        </section>
    </main>
@endsection
@push('body_classes') footer-about-us-settings-page @endpush

...
@section('content')
    @php
      ...
      $footerLinkTitle = empty($view->data->bottomlinks['disclosures_text']) ? "Disclosures" : $view->data->bottomlinks['disclosures_text'];
    ...
    <main class="main" data-global="{{ @$view->data->globalOptions['disclosures_type'] }}" data-single="{{ @$view->data->bottomlinks['disclosures_type'] }}">
        ...
        <!-- Title wrap of the page -->
            ...
            <form id="pricay-page" enctype="multipart/form-data"
                ...
                <input type="hidden" name="theselectiontype" id="theselectiontype" value="disclosures">
                <input type="hidden" name="disclosures_active" id="disclosures_active"
                       value="{{  @$view->data->bottomlinks['disclosures_active'] }}">
                <input type="hidden" name="gfot_ai_val" id="gfot_ai_val"
                       value="{{  @$view->data->globalOptions['disclosures_active'] }}">
                                ...
                                <ul class="action__list">
                                    <li class="action__item">
                                        ...
                                        <input @php echo $checked; @endphp id="fp-privacy-policy"
                                               ...
                                               data-field = 'disclosures_active'
                                               class="pptogbtn global-switch gfooter-toggle"
                                               data-lpkeys="@php echo @$view->data->lpkeys."~disclosures_active"; @endphp"
                                ...
                                <div class="input__wrapper">
                                    <div class="select2js__linkpage-option-parent">
                                        <select class="select2js__linkpage-option global-select"
                                                data-global_val="{{@$view->data->globalOptions['disclosures_type']}}"
                                                data-val="{{@$view->data->bottomlinks['disclosures_type']}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input__wrapper">
                                    <input id="theurltext" name="theurltext" class="form-control global-input-text"
                                           type="text"
                                           data-global_val="{{ @$view->data->globalOptions['disclosures_text'] }}"
                                           data-val="@php echo @$view->data->bottomlinks['disclosures_text'];  @endphp"
                                           value="@php echo @$view->data->bottomlinks['disclosures_text'];  @endphp" data-form-field>
                                </div>
                            </div>
                        </div>
                        <div class="content__wrapper">
                            <div class="own-web" id="webmodal"
                                 style=" @php echo (@$view->data->bottomlinks['disclosures_type']=='m'?'display:block':'display:none') @endphp;">
                                <div class="classic-editor__wrapper froala-editor-full-width froala-editor-fixed-width funnel-setting-pages-editor">
                                    <textarea name="footereditor" id="footereditor"
                                        ...
                                        @php echo @$view->data->bottomlinks['disclosures']; @endphp
                                    </textarea>
                                </div>
                            </div>
                                    ...
                                    <div class="col-10 pl-2">
                                        <div class="input__wrapper">
                                            <input id="theurl" name="theurl" class="form-control global-input-text"
                                                   data-global_val="{{ @$view->data->globalOptions['disclosures_url'] }}"
                                                   data-val="@php echo @$view->data->bottomlinks['disclosures_url'];@endphp"
                                                   value="@php echo @$view->data->bottomlinks['disclosures_url'];@endphp"
            ...
            <div id="text-area-content" style="display: none">@php echo htmlspecialchars_decode(@$view->data->bottomlinks['disclosures']) @endphp</div>
            <div id="text-area-content-global" style="display: none">{!! @$view->data->globalOptions['disclosures'] !!}</div>


        </section>
    </main>
@endsection
@push('body_classes') disclosures-settings-page @endpush

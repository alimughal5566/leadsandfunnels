                            ...
                            <li class="list-steps__li list-steps__li--company">
                                ...
                                <div class="list-steps__slide">
                                    <div class="field-holder">
                                        <label for="company"><i class="icon icon-building"></i></label>
                                        <input type="text"
...
@push('FooterScripts')
    ...
    <script type="text/javascript" src="{{ config('view.theme_assets') }}/external/color-thief.js?v={{ LP_VERSION }}"></script>

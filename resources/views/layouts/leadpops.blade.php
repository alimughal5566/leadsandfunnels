...
<head>
    ...
    @php
        $default_css = array();
        array_push($default_css, LP_ASSETS_PATH.'/external/bootstrap/css/bootstrap.css?v='.LP_VERSION);
        array_push($default_css, LP_ASSETS_PATH.'/external/font-awesome-4.7.0/css/font-awesome.css?v='.LP_VERSION);
        array_push($default_css, LP_ASSETS_PATH.'/external/custom-scroll/jquery.mCustomScrollbar.css?v='.LP_VERSION);
        array_push($default_css, LP_ASSETS_PATH.'/external/bootstrap-toggle/css/bootstrap-toggle.min.css?v='.LP_VERSION);
        array_push($default_css, LP_ASSETS_PATH.'/external/colorpicker/css/colorpicker.css?v='.LP_VERSION);
        array_push($default_css, LP_ASSETS_PATH.'/external/colorpicker/css/layout.css?v='.LP_VERSION);
        array_push($default_css, LP_ASSETS_PATH.'/external/bootstrap-slider/css/bootstrap-slider.min.css?v='.LP_VERSION);
        array_push($default_css, LP_ASSETS_PATH.'/external/jquery.ics-gradient-editor.css?v='.LP_VERSION);
        array_push($default_css, LP_ASSETS_PATH.'/external/select2/css/select2.css?v='.LP_VERSION);
        array_push($default_css, LP_ASSETS_PATH.'/external/select/css/bootstrap-select.css?v='.LP_VERSION);
        array_push($default_css, LP_ASSETS_PATH.'/css/style.css?v='.LP_VERSION);
        array_push($default_css, LP_ASSETS_PATH.'/external/date-picker/daterangepicker.css?v='.LP_VERSION);
        array_push($default_css, LP_ASSETS_PATH.'/css/stats.css?v='.LP_VERSION);
        array_push($default_css, LP_ASSETS_PATH.'/css/style-steele.css?v='.LP_VERSION);
        array_push($default_css, LP_ASSETS_PATH.'/css/leadpops_helper.css?v='.LP_VERSION);
        array_push($default_css, LP_ASSETS_PATH.'/external/bootstrap/css/bootstrap-nonresponsive.css?v='.LP_VERSION);
        array_push($default_css, LP_ASSETS_PATH . '/external/owlcarousel/assets/owl.carousel.min.css?v=' . LP_VERSION);
        array_push($default_css, LP_ASSETS_PATH . '/external/owlcarousel/assets/owl.theme.default.min.css?v=' . LP_VERSION);
        ...
        array_push($default_css, LP_ASSETS_PATH . "/external/froala-editor/css/froala_extend.css?v=" . LP_VERSION);
        array_push($default_css, LP_ASSETS_PATH . "/external/froala-editor/css/froala_style.min.css?v=" . LP_VERSION);
        array_push($default_css, LP_ASSETS_PATH . "/external/froala-editor/css/froala_custom.css?v=" . LP_VERSION);
        array_push($default_css, LP_ASSETS_PATH . '/css/msg-note.css?v=' . LP_VERSION);
        ...
        if ((@$view->session->clientInfo->sticky_bar_v2 == 1)){
            array_push($default_css, LP_ASSETS_PATH.'/external/dropzone/dropzone.css?v='.LP_VERSION);
            array_push($default_css, LP_ASSETS_PATH.'/external/nano-scroll/nanoscroller.css?v='.LP_VERSION);
            array_push($default_css, LP_ASSETS_PATH.'/css/sticky-bar_v2.css?v='.LP_VERSION);
            array_push($default_css, LP_ASSETS_PATH.'/css/stats_v2.css?v='.LP_VERSION);
        } else {
            array_push($default_css, LP_ASSETS_PATH.'/css/sticky-bar.css?v='.LP_VERSION);
        }
    @endphp
    ...
    <section class="super_banner">
        <span class="super_banner__link">
          <div class="super_banner__contents">
            <div class="super_banner__headline" style="opacity: 1; transform: translateX(0px) translateY(0px);">{{ env("BOOK_NOW_TEXT", "Schedule your FREE 1:1 Digital Marketing Assessment!") }}</div>
            <a href="{{ env("BOOK_NOW_LINK", "https://book-demo.leadpops.com/") }}" target="_blank"
               class="btn btn--extra-small super_banner__btn" style="color: rgb(255, 255, 255); transform: scale(1);">
              {{ env("BOOK_NOW_CTA", "Book Now") }}
...
@php
    $default_js = array();
    if(@$_COOKIE['dev'] == 'me'){
        array_push($default_js, LP_ASSETS_PATH.'/external/jquery-3.2.1.min.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH.'/external/bootstrap/js/bootstrap.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH.'/external/select/js/bootstrap-select.min.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH.'/external/select2/js/select2.min.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH.'/external/colorpicker/js/colorpicker.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH.'/external/custom-scroll/jquery.mCustomScrollbar.concat.min.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH.'/external/bootstrap-slider/bootstrap-slider.min.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH.'/external/bootstrap-toggle/js/bootstrap-toggle.min.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH.'/js/leadpops_admin.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH.'/external/validation/jquery.validate.js?v='.LP_VERSION);

        array_push($default_js, LP_ASSETS_PATH.'/js/jquery.flip.min.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH.'/external/input-mask/jquery.inputmask.bundle.min.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH.'/external/jquery.ics-gradient-editor.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH."/external/date-picker/moment.js?v=".LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH."/external/date-picker/moment-timezone.min.js?v=".LP_VERSION);
        ...
        array_push($default_js, LP_ASSETS_PATH."/external/date-picker/daterangepicker.js?v=".LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH."/external/nice-scroll/jquery.nicescroll.min.js?v=".LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH.'/js/lp_stats.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH.'/js/lp_sticky_bar.js?v='.LP_VERSION);

        array_push($default_js, LP_ASSETS_PATH.'/js/global-functions.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH.'/js/custom.js?v='.LP_VERSION);
        array_push($default_js, "//fast.wistia.net/assets/external/E-v1.js");
        array_push($default_js, LP_ASSETS_PATH.'/js/leadpops_helper.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH . "/external/owlcarousel/owl.carousel.js?v=" . LP_VERSION);
        ...
        array_push($default_js, LP_ASSETS_PATH.'/external/froala-editor/js/video.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH . "/external/froala-editor/js/file.js?v=" . LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH . "/external/froala-editor/js/font_family.min.js?v=" . LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH . '/js/msg-note.js?v=' . LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH . "/external/froala-editor/js/froala-custom.js?v=" . LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH.'/js/custom-steele.js?v='.LP_VERSION);
    }
    else {
        array_push($default_js, LP_ASSETS_PATH.'/external/jquery-3.2.1.min.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH.'/external/jquery-ui.min.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH.'/external/bootstrap/js/bootstrap.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH.'/external/select/js/bootstrap-select.min.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH.'/external/select2/js/select2.min.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH.'/external/colorpicker/js/colorpicker.js?v='.LP_VERSION);
        ...
        array_push($default_js, LP_ASSETS_PATH.'/external/froala-editor/js/super_footer_cta_link.js?v='.LP_VERSION);
        }else{
         array_push($default_js, LP_ASSETS_PATH.'/external/froala-editor/js/cta_link.js?v='.LP_VERSION);
        }
        array_push($default_js, LP_ASSETS_PATH .'/external/froala-editor/js/video.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH . "/external/froala-editor/js/file.js?v=" . LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH . "/external/froala-editor/js/font_family.min.js?v=" . LP_VERSION);
    ...
    if(@$view->session->clientInfo->sticky_bar_v2 == 1){
        array_push($default_js, LP_ASSETS_PATH.'/external/nano-scroll/jquery.nanoscroller.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH.'/external/froala-editor/js/stickybar_froala_custom.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH.'/external/dropzone/dropzone.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH.'/js/lp_sticky_bar_v2.js?v='.LP_VERSION);
        array_push($default_js, LP_ASSETS_PATH.'/js/lp_stats_v2.js?v='.LP_VERSION);
    }else{
        array_push($default_js, LP_ASSETS_PATH.'/js/lp_sticky_bar.js?v='.LP_VERSION);
    }

...
<head>
    ...
    <script type="text/javascript" src="{{ LP_ASSETS_PATH }}/external/validation/jquery.validate.js?v={{ LP_VERSION }}"></script>
    <!-- google fonts -->
    ...
    <link href="{{LP_ASSETS_PATH . '/css/guest.css?v='.LP_VERSION}}" rel="stylesheet" type="text/css">
    @stack('styles')
    @stack('scripts')

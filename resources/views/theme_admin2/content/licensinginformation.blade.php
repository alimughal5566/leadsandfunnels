    ...
    <section id="page-footer-edit-1">
        <div class="container">
            ...
            <form class="form-inline" enctype="multipart/form-data" name="ffooter" id="ffooter" method="POST" action="@php echo LP_BASE_URL.LP_PATH."/popadmin/savefooteroptions"; @endphp">
                ...
                <input type="hidden" name="theselection" id="theselection"  value="@php echo @$view->data->bottomlinks['licensing_type'] @endphp">
                ...
                <div class="lp-auto-responder">
                    <div class="lp-auto-responder-head">
                        <div class="row">
                            <div class="col-md-10">
                                <div class="col-left">
                                    <h2 class="lp-heading-2">@php echo (@$view->data->bottomlinks['licensing_text'] == "" ? "Licensing Information" : @$view->data->bottomlinks['licensing_text']);  @endphp</h2>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="custom-btn-toggle">
                                    ...
                                    @endphp
                                    <input @php echo $checked; @endphp data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-width="100" data-on="INACTIVE" data-off="ACTIVE" type="checkbox" class="pptogbtn" data-lpkeys="@php echo @$view->data->lpkeys."~licensing_active"; @endphp">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="lp-pp-box">
                                ...
                                <select class="lp-select2 selectpicker" name="linktype" id="linktype" onchange="mytoggledestination()">
                                    ...
                                    <option value="u" @php echo (@$view->data->bottomlinks['licensing_type']=='u'?'selected="selected"':'') @endphp>Another Website</option>
                                    <option value="m" @php echo (@$view->data->bottomlinks['licensing_type']=='m'?'selected="selected"':'') @endphp>Your Funnel</option>
                                </select>
                                <label for="textMsg" class="control-label lp-auto-responder-label lp-pp-link-lable">Link text</label>
                                <input type="text" class="lp-auto-responder-inbox" name="theurltext"  id="theurltext"  value="@php echo @$view->data->bottomlinks['licensing_text'];  @endphp">
                            </div>
                        </div>
                    </div>
                    <div id="webaddress" class="row">
                        <div class="col-md-12">
                            <div class="lp-footer-msg-box">
                                ...
                                <input type="text" class="lp-auto-responder-inbox" name="theurl"  id="theurl" value="@php echo @$view->data->bottomlinks['licensing_url'];@endphp">
                            </div>
                        </div>
                    </div>
                    <div id="webmodal" class="row" style=" @php echo (@$view->data->bottomlinks['licensing_type']=='m'?'display:block':'display:none') @endphp;">
                        <div class="col-md-12">
                            <div class="lp-msg-box">
                                <textarea name="footereditor" class="lp-froala-textbox lp-pp-section">@php echo @$view->data->bottomlinks['licensing']; @endphp</textarea>
                            </div>
                        </div>
                    </div>
                </div>

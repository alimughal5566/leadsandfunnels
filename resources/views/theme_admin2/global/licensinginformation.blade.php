...
<section id="page-footer-edit-1">
    <div class="container">
        ...
        <form class="form-inline" enctype="multipart/form-data" name="gffooter" id="gffooter" method="POST" action="{{  LP_BASE_URL.LP_PATH }}/global/savefooteroptions">
            ...
            <input type="hidden" name="licensing_information_active" id="licensing_information_active" value="{{  @$view->data->globalOptions['licensing_information_active'] }}">
            <input type="hidden" name="gfot_ai_val" id="gfot_ai_val" value="{{  @$view->data->globalOptions['licensing_information_active'] }}">
            <input type="hidden" name="theselection" id="theselection"  value="{{  @$view->data->globalOptions['licensing_type'] }}">
            ...
            <div class="lp-auto-responder">
                <div class="lp-auto-responder-head">
                    <div class="row">
                        <div class="col-md-10">
                            <div class="col-left">
                                <h2 class="lp-heading-2">Licensing Information</h2>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="custom-btn-toggle">
                                @php
                                    $checked="";
                                    if(@$view->data->globalOptions['licensing_information_active']=='y'){
                                        $checked="checked";
                                    }
                                 @endphp
                                 <input {{  $checked }} class="gfooter-toggle" data-field = 'licensing_information_active' data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-width="100" data-on="INACTIVE" data-off="ACTIVE" type="checkbox">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="lp-pp-box">
                            <label for="textMsg" class="control-label lp-auto-responder-label lp-pp-lable">Link Licensing Info to </label>
                            <select class="selectpicker lp-select2" name="linktype" id="linktype" onchange="mytoggledestination()">
                                <option value="-1">Select One</option>
                                <option value="u" @if(@$view->data->globalOptions['licensing_type']=='u'){{'selected="selected"'}} @endif>Another Website</option>
                                <option value="m" @if(@$view->data->globalOptions['licensing_type']=='m'){{'selected="selected"'}} @endif>Your Funnel</option>
                            </select>
                            <label for="textMsg" class="control-label lp-auto-responder-label lp-pp-link-lable">Link text</label>
                            <input type="text" class="lp-auto-responder-inbox" name="theurltext"  id="theurltext"  value="{{  @$view->data->globalOptions['licensing_text'] }}">
                        </div>
                    </div>
                </div>
                <div id="webaddress" class="row">
                    <div class="col-md-12">
                        <div class="lp-footer-msg-box">
                            ...
                            <input type="text" class="lp-auto-responder-inbox" name="theurl"  id="theurl" value="{{  @$view->data->globalOptions['licensing_url'] }}">
                        </div>
                    </div>
                </div>
                <div id="webmodal" class="row" style="@if(@$view->data->globalOptions['licensing_type']=='m'){{'display:block'}}@else{{'display:none'}}@endif">
                    <div class="col-md-12">
                        <div class="lp-msg-box">
                            <textarea name="footereditor" class="lp-pp-section lp-froala-textbox">{{  @$view->data->globalOptions['licensing'] }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="lp-save">
                        <div class="custom-btn-success">
                            <button type="button" onclick="savegloballicense();" class="btn btn-success"><strong>SAVE</strong></button>
                        </div>
                    </div>
                </div>
            </div>

...
class ForgotPasswordLinkGenerator extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'generate:forgot-password-link {email}';
    ...
    protected $description = 'Generate forgot password link by email';

...
class SyncChargebeePlanInLocalDb extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'deprecated:chargebee-plans:sync';
     ...
     * @var string
     */
    protected $description = 'Get plans from Chargebee and sync local DB with it.';

...
class iSDK
{
    ...
    /**
     * @method clientCon
	 * LEADPOPS IFS INTEGRATION USE ONLY
     * @description Creates and tests the API Connection to the Application for clients using the IFS integration
     ...
     */
    public function clientCon($name, $key)
    {
     ...
     * @return array
     */
    public function dsQuery($tName, $limit, $page, $query, $rFields, $orderBy="Id", $ascending=false)
    {
        $carray = array(
            php_xmlrpc_encode($tName),
            php_xmlrpc_encode((int)$limit),

...
class StatsController extends BaseController {
    ...
    public function statistics(Request $request){
        ...
        $this->active_menu = LP_Constants::STATS;
...
/**********************************************************************************************
 * COPY OF blockipaddresslist function with some modifications for version 3. Need JSON object not HTML.
 * Once v3 is stable we can remove blockipaddresslist function  (Farhan Khan)
 *********************************************************************************************/
    public function blockipaddresslist_v3(Request $request){
        if(isset($request)){
            LP_Helper::getInstance()->getCurrentHashData($request->input('hash'));
            $funnel = LP_Helper::getInstance()->getFunnelData();
            $params = [
            ...
            $ip_lists =  $this->stats->getIpAddressList($params);
            echo json_encode(array("success"=>true, "data"=>$ip_lists));
//
//            $html = "<div class=\"lead-alert-col ip-block-col\">\n";
//            $html .= "<div class=\"row\">\n";
//            $html .= "<div class=\"col-sm-4\"><h3 class=\"lead-alert-caption lead-alert-email-address\">IP Name</h3></div>\n";

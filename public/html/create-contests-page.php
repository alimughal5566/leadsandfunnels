        ...
        <main class="main">
            <section class="main-content">
                    ...
                    <div class="main-content__head">
                        <div class="col-left">
                            <h1 class="title">
                                Funnel Contests / Funnel: <span class="funnel-name">203K Hybrid Loans</span>
                            </h1>
                        </div>
                        <div class="col-right">
                    ...
                    <!-- content of the page -->
                        <div class="c-contest__panel">
                            <div class="c-contest__wrapper">
                                <h2 class="c-contest__placeholder">You haven't created any contests yet.</h2>
                                <a class="button button-primary" href="contests-page.php">create my first contest</a>
                            </div>
                        </div>
                    <!-- footer of the page -->
                    <div class="footer">

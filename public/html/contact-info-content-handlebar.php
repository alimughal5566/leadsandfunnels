                ...
                <div class="col">
                        ...
                        <div class="step-holder">
                            <div class="form-group">
                                <div class="input-wrap">
                                    <input type="text" id="first_name" class="form-control validate-input" autocomplete="off" data-function-name="formValidation">
                    ...
                    <div class="question_contact-info__fields">
                        <div class="step-holder">
                            <div class="form-group">
                                <div class="input-wrap">
                                    <input type="text" id="last_name" class="form-control validate-input" autocomplete="off" data-function-name="formValidation">
                    ...
                    <div class="question_contact-info__fields">
                        <div class="step-holder">
                            <div class="form-group">
                                <div class="input-wrap">
                                    <input type="tel" id="phone_number" class="form-control validate-input" autocomplete="off" data-function-name="formValidation">

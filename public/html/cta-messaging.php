                ...
                <section class="main-content">
                    <form id="ctaform" action="">
                        ...
                        <div class="main-content__head main-content__head_tabs">
                            <div class="col-left">
                                <h1 class="title">
                                    Call-to-Action / Funnel: <span class="funnel-name el-tooltip" title="203K Hybrid Loans">203K Hybrid Loans</span>
                                </h1>
                            </div>
                            <div class="col-right">
                                ...
                                <div class="tab__wrapper">
                                    <ul class="nav nav__tab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-toggle="pill" href="#tbbasic">Basic</a>
                                        </li>
                                        <li class="nav-item disabled el-tooltip" title="This feature is coming soon!">
                                            <a class="nav-link" data-toggle="pill" href="#tbadvanced">Advanced</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="col-right">
                                    <div class="action">
                                        ...
                                        <span class="action__span">
                                            <a href="javascript:void(0)" onclick="return resethomepagemessage('1');" class="action__link el-tooltip" title="This will reset your Main Message <br> to the leadPops default messaging <br> and styling for this type of Funnel.">
                                ...
                                <div class="col-right">
                                    <div class="action">
                                        <ul class="action__list">
                                            <li class="action__item action__item_separator">
                                        <span class="action__span">
                                            <a href="javascript:void(0)" onclick="return resethomepagemessage('2');" class="action__link el-tooltip" title="This will reset your Main Message <br> to the leadPops default messaging <br> and styling for this type of Funnel.">
                                                <span class="ico ico-undo"></span>Reset
                                            </a>
                                        </span>
                                            </li>

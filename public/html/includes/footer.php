...
<!--    <script src="assets/js/exporting.js?v=--><?php //echo VERSION; ?><!--"></script>-->
    ...
    <script src="assets/external/flatpick/flatpickr.js?v=<?php echo VERSION; ?>"></script>
    ...
    <script src="assets/handlebars/templates.js?v=<?php echo VERSION; ?>"></script>
    ...
    <?php
        ...
        if($page_name == 'background-advance.php') {
            ...
            <script src="https://unpkg.com/fabric@latest/dist/fabric.js?v=<?php echo VERSION; ?>"></script>
        ...
        if($page_name == 'theme.php') {
            ?>
            <script src="assets/external/codemirror/codemirror.js?v=<?php echo VERSION; ?>"></script>
            <script src="assets/external/codemirror/mode.js?v=<?php echo VERSION; ?>"></script>
            <script src="assets/pages/theme.js?v=<?php echo VERSION; ?>"></script>
            <?php
        }
        ...
        if($page_name == 'funnel-question-group.php') {
            ...
            <script src="assets/pages/conditional-logic.js?v=<?php echo VERSION; ?>"></script>
        ...
        if($page_name == 'funnel-question-group-birthday.php') {
            ?>
            <script src="assets/pages/funnel-question-birthday-content.js?v=<?php echo VERSION; ?>"></script>
            <script src="assets/pages/funnel-question-birthday-overlay.js?v=<?php echo VERSION; ?>"></script>
            <?php
        }
        if($page_name == 'funnel-question-group-timepicker.php') {
            ?>
            <script src="assets/pages/funnel-question-timepicker-content.js?v=<?php echo VERSION; ?>"></script>
            <script src="assets/pages/funnel-question-timepicker-overlay.js?v=<?php echo VERSION; ?>"></script>
            <?php
        }
        if($page_name == 'funnel-question-group-datepicker.php') {
            ?>
            <script src="assets/pages/funnel-question-datepicker-content.js?v=<?php echo VERSION; ?>"></script>
            <script src="assets/pages/funnel-question-datepicker-overlay.js?v=<?php echo VERSION; ?>"></script>
            <?php
        }
        ...
        if($page_name == 'funnel-question-group-dropdown.php') {
            ?>
            <script src="assets/pages/funnel-question-dropdown-content.js?v=<?php echo VERSION; ?>"></script>
            <script src="assets/pages/funnel-question-dropdown-overlay.js?v=<?php echo VERSION; ?>"></script>
            <?php
        }
        if($page_name == 'funnel-question-group-address.php') {
            ?>
            <script src="assets/pages/funnel-question-address-content.js?v=<?php echo VERSION; ?>"></script>
            <script src="assets/pages/funnel-question-address-overlay.js?v=<?php echo VERSION; ?>"></script>
            <?php
        }
        if($page_name == 'funnel-question-group-number.php') {
            ?>
            <script src="assets/pages/funnel-question-number-content.js?v=<?php echo VERSION; ?>"></script>
            <script src="assets/pages/funnel-question-number-overlay.js?v=<?php echo VERSION; ?>"></script>
            <?php
        }
        if($page_name == 'funnel-question-group-contact-info.php') {
            ?>
            <script src="assets/pages/funnel-question-contact-info-content.js?v=<?php echo VERSION; ?>"></script>
            <script src="assets/pages/funnel-question-contact-info-overlay.js?v=<?php echo VERSION; ?>"></script>
            <?php
        }
        if($page_name == 'funnel-question-group-cta.php') {
            ?>
            <script src="assets/pages/funnel-question-cta-content.js?v=<?php echo VERSION; ?>"></script>
            <script src="assets/pages/funnel-question-cta-overlay.js?v=<?php echo VERSION; ?>"></script>
            <?php
        }
        ...
        if($page_name == 'funnel-question-group-slider.php') {
            ?>
            <script src="assets/pages/funnel-question-slider-overlay.js?v=<?php echo VERSION; ?>"></script>
            <script src="assets/pages/funnel-question-slider-content.js?v=<?php echo VERSION; ?>"></script>
            <?php
        }
        if($page_name == 'list-tcpa-message.php' || $page_name == 'tcpa-message.php' ) {
            ?>
            <script src="assets/pages/tcpa-messages.js?v=<?php echo VERSION; ?>"></script>
            <?php
        }

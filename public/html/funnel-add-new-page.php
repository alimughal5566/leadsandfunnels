                ...
                <section class="main-content">
                    <form id="thkform"  method="get" action="">
                        ...
                        <div class="main-content__head">
                            <div class="col-left">
                                <h1 class="title">
                                    Add New Page / Funnel: <span class="funnel-name el-tooltip" title="203K Hybrid Loans">203K Hybrid Loans</span>
                                </h1>
                            </div>
                            <div class="col-right">
                                <div class="action">
                                    <ul class="action__list">
                                        ...
                                        <li class="action__item">
                                            <a href="funnel-thank-you-page.php" class="back-link"><span class="icon icon-back ico-caret-up"></span> Back to Thank You Page list</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>

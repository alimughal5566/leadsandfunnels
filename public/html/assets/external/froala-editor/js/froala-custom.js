var font_object = {};
var arr = ['footer-basic.php','thank-you-edit-basic.php','global','extra-content.php'];
var super_footer = ['footer-basic.php','extra-content.php','global','thank-you-edit-basic.php','auto-responder-basic.php'];
var show_video = ['footer-basic.php','thank-you-edit-basic.php','privacy-policy.php'];
var show_cta = ['auto-responder-basic.php','thank-you-edit-basic.php','global'];
...
jQuery(document).ready(function() {
    ...
    $(function() {
        ...
        if(page[1] == 'auto-responder-basic.php') {
            hide_video = true;
        }
        ...
        if(hide_video) {
            var toolbarButtonsList = [ 'bold', 'italic', 'underline', 'strikeThrough', 'fontFamily', 'fontSize','color', 'lineHeight', 'align', 'formatOL', 'formatUL', 'outdent', 'indent','insertLink','insertImage','emoticons', 'insertHR','insertCTALink', 'html' ,'undo', 'redo', 'starOption' ];
        }
        if(page[1] == 'cta-message-advance.php') {
            var toolbarButtonsList = [ 'bold', 'italic', 'underline', 'strikeThrough', 'fontFamily', 'fontSize','color', 'lineHeight', 'align', 'formatOL', 'formatUL', 'outdent', 'indent','insertLink', 'insertImage','insertVideo','emoticons', 'insertHR', 'html' ,'undo', 'redo', 'starOption' ];
        }
        if(page[2] =='cta-advance-pop.php') {
            var toolbarButtonsList = [ 'bold', 'italic', 'underline', 'strikeThrough', 'fontFamily', 'fontSize','color', 'lineHeight', 'align', 'formatOL', 'formatUL', 'outdent', 'indent','insertLink', 'insertImage','insertVideo','emoticons', 'starOption' ];
        }
        if(page[2] == 'footer-basic.php') {
            var toolbarButtonsList = [ 'bold', 'italic', 'underline', 'strikeThrough', 'fontFamily', 'fontSize','color', 'lineHeight', 'align', 'formatOL', 'formatUL', 'outdent', 'indent','insertLink', 'insertImage','insertVideo','emoticons', 'insertHR','insertCTALink', 'template_dropdown', 'html' ,'undo', 'redo', 'starOption' ];
        }
        if(page[2] == 'extra-content.php') {
            var toolbarButtonsList = [ 'bold', 'italic', 'underline', 'strikeThrough', 'fontFamily', 'fontSize','color', 'lineHeight', 'align', 'formatOL', 'formatUL', 'outdent', 'indent','insertLink', 'insertImage','insertVideo','emoticons', 'insertHR','insertCTALink', 'template_dropdown', 'html' ,'undo', 'redo', 'starOption' ];
        }
        if(page[2] == 'privacy-policy.php') {
            var toolbarButtonsList = [ 'bold', 'italic', 'underline', 'strikeThrough', 'fontFamily', 'fontSize','color', 'lineHeight', 'align', 'formatOL', 'formatUL', 'outdent', 'indent','insertLink', 'insertImage','insertVideo','emoticons', 'insertHR', 'html' ,'undo', 'redo', 'starOption' ];
        }
        ...
        if(page[2] =='cta-advance-pop.php') {
            var toolbarButtonListPopup = [ 'insertHR', 'html' ,'undo', 'redo', 'subscript','superscript','-','paragraphStyle','paragraphFormat','embedly', 'insertFile','insertTable', '-', 'selectAll', 'clearFormatting','spellChecker', 'help'];
        }
      ...
      window.lp_html_editor =  $('.lp-froala-textbox').froalaEditor({
            ...
            .on('froalaEditor.image.beforeRemove', function (e, editor) {
             ...
             .on('froalaEditor.click', function (e, editor, clickEvent) {
                 ...
                 $(_link).attr('id','cta_active');
                 var el =   document.querySelector("#cta_active #current");
                 if(el &&  el.childNodes[0].length == getCaretPosition()) {
                     insertLink(_link, editor, el.childNodes[0].length+1);
                 }
          })
            .on('froalaEditor.keydown', function (e, editor, keydownEvent) {
                ...
                if(keydownEvent.keyCode == 8 || keydownEvent.keyCode  == 46) {
                    ...
                    if (el != null) {
                        ...
                        if(!str.endsWith("&nbsp;")) {
                            insertLink(_link, editor,el.innerText.length);
                        }
                    }
                }

                // var editorHtml = editor.html.get();
                // var regex = /(:?<a href="tel\:\(?\d{3}\)?[\-\. ]\d{3}[\-\.]\d{4}">)?\(?\d{3}\)?[\-\. ]\d{3}[\-\.]\d{4}(:?<\/a>)?/g
                // if (editorHtml != null) {
                //     var inserthtml = editorHtml.replace(regex,function (match){
                ...
                //     // editor.html.set('');
                //     editor.html.insert(inserthtml);
                // }
            })
          // .on('froalaEditor.keyup', function (e, editor, keyupEvent){
          ...
          //         // console.info(inserthtml)
          //         // editor.html.set('');
          //         $('.fr-element.fr-view').html(inserthtml);
          //     }
          // })
          ...
          //         console.log("in debounce funtion")
          //         var htmlMatch = editorHtml.match(/(\d{3})[^\d]*(\d{3})[^\d]*(\d{4})/);
          //         if (htmlMatch != null && htmlMatch.length > 3) {
          //             var phonenumber = htmlMatch[0];
          //             var inserthtml = editorHtml.replaceAll(phonenumber,'<a href="tel:'+phonenumber+'">'+phonenumber+'')
          //             editor.html.set(inserthtml);
          //         }
          //     });
          // })

    ...
    m.extend(m.FE.POPUP_TEMPLATES, {
        ...
        function f(e, t, n) {
            ...
            if (a) {
                ...
                i ? (i.wrap('<a href="' + e + '" class = "ctalink" ></a>'), d.image.hasCaption() && i.parent().append(i.parents(".fr-img-caption").find(".fr-inner"))) : (d.format.remove("a"), d.selection.isCollapsed() ? (t = 0 === t.length ? r : t, d.html.insert('<a href="' + e + '" class = "ctalink">' + m.FE.START_MARKER + t.replace(/&/g, "&amp;").replace(/</, "&lt;", ">", "&gt;") + m.FE.END_MARKER + "</a>"), d.selection.restore()) : 0 < t.length && t != d.selection.text().replace(/\n/g, "") ? (d.selection.remove(), d.html.insert('<a href="' + e + '" class = "ctalink">' + m.FE.START_MARKER + t.replace(/&/g, "&amp;") + m.FE.END_MARKER + "</a>"), d.selection.restore()) : (! function() {
        ...
        return {
            ...
            _showInsertPopup: function() {
                var e = d.$tb.find('.fr-command[data-cmd="insertCTALink"]'),
                    t = d.popups.get("link.insert");
                if (t || (t = s()), !t.hasClass("fr-active"))
                    if (d.popups.refresh("link.insert"), d.popups.setContainer("link.insert", d.$tb || d.$sc), e.is(":visible")) {

...
var zip_code_overlay = {

    overlay_select_list : [
        {selecter:".zip-code-icon-type", parent:".zip-code-input-icon-parent"},
        {selecter:".zip-code-message-type", parent:".zip-code-input-message-parent"},
    ],
    ...
    **/
    ...
    allCustomSelect: function () {
        var selectlist = zip_code_overlay.overlay_select_list;
        for(var i = 0; i < selectlist.length; i++){
            zip_code_overlay.initCustomSelect(selectlist[i].selecter,selectlist[i].parent);
        }
    },
  ...
  **/
   ...
   **/
    ...
    rangebar: function () {
        jQuery('#zip-code-font-slider').bootstrapSlider({
            formatter: function(value) {
                jQuery('.zip-code-font').val(value);
                jQuery(".cta-btn").css({
                    'font-size': value,
                });
                return   value +'px';
            ...
            min: 16,
            max: 50,
            value: jQuery('.zip-code-font').val(),
            tooltip: 'always',
            tooltip_position: 'bottom'
        });

        jQuery('#zip-code-icon-size-slider').bootstrapSlider({
            formatter: function(value) {
                jQuery('.zip-code-icon-size').val(value);
            ...
            min: 10,
            max: 28,
            value: jQuery('.zip-code-icon-size').val(),
            tooltip: 'always',
            tooltip_position: 'bottom'
        });
    ...
    **/
    ...
    color_picker: function () {
        ...
        $('#zip-code-clr-icon').click(function () {
            var name = ".zip-code-icon-clr";
        ...
        $('#zip-code-icon-clr').ColorPicker({
            ...
            onChange: function (hsb, hex, rgb, rgba) {
                ...
                $(".zip-code-icon-clr .color-box__r .color-box__rgb").val(rgb.r);
                $(".zip-code-icon-clr .color-box__g .color-box__rgb").val(rgb.g);
                $(".zip-code-icon-clr .color-box__b .color-box__rgb").val(rgb.b);
                $(".zip-code-icon-clr .color-box__hex-block").val('#'+hex);
                $('#zip-code-clr-icon').find('.last-selected__box').css('backgroundColor', rgba_fn);
                $('#zip-code-clr-icon').find('.last-selected__code').text('#'+hex);
 ...
 * */
    ...
    **/
    ...
    init: function() {
        ...
        zip_code_overlay.openclose();
        zip_code_overlay.customscroll();
        zip_code_overlay.selecticon();
        zip_code_overlay.rangebar();
        zip_code_overlay.color_picker();
        zip_code_overlay.allCustomSelect();
        zip_code_overlay.outsideclick();
        zip_code_overlay.color_picker_dropdown();
        zip_code_overlay.tooltip();
        zip_code_overlay.quick_access();
        zip_code_overlay.outside_hover();
        zip_code_overlay.farola_editor();
    },
};

jQuery(document).ready(function() {
    zip_code_overlay.init();
});

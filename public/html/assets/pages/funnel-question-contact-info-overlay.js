window.selectItems = {
    'question-contact-info-icon-type' :[
        {
            id:0,
...
var contact_info_overlay = {
    ...
    initCustomSelect: function (selecter,parent) {
        ...
        if(selectorClass == 'contact-variation-step1') {
            ...
            _selector.on('change', function () {
                var $this = $(this).val();
                if (this.value == 1){
                    $(".step-parent-active .first-name").css("display", "block");
                    $(".step-parent-active .last-name").css("display", "none");
                    $(".step-parent-active .full-name").css("display", "none");
                } else if (this.value == 2){
                    $(".step-parent-active .first-name").css("display", "block");
                    $(".step-parent-active .last-name").css("display", "block");
                    $(".step-parent-active .full-name").css("display", "none");
                } else if (this.value == 3){
                    $(".step-parent-active .first-name").css("display", "none");
                    $(".step-parent-active .last-name").css("display", "none");
                    $(".step-parent-active .full-name").css("display", "block");
                }
            });
        }

        if(selectorClass == 'input-type1-step1') {
            $(selecter).val(2).change();
            _selector.on('change', function () {
                var $this = $(this).val();
                if (this.value == 1){
                    $(".step-parent-active .name-field").css("display", "block");
                    $(".step-parent-active .number-field").css("display", "none");
                    $(".step-parent-active .email-field").css("display", "none");
                } else if (this.value == 2){
                    $(".step-parent-active .name-field").css("display", "none");
                    $(".step-parent-active .number-field").css("display", "none");
                    $(".step-parent-active .email-field").css("display", "block");
                } else if (this.value == 3){
                    $(".step-parent-active .name-field").css("display", "none");
                    $(".step-parent-active .number-field").css("display", "flex");
                    $(".step-parent-active .email-field").css("display", "none");
                }
            });
        }
        ...
        if(selectorClass == 'input-type2-step1') {
            ...
            _selector.on('change', function () {
                var $this = $(this).val();
                if (this.value == 1){
                    $(".name-field").css("display", "flex");
                    $(".number-field").css("display", "none");
                    $(".email-field").css("display", "none");
                } else if (this.value == 2){
                    $(".name-field").css("display", "none");
                    $(".number-field").css("display", "none");
                    $(".email-field").css("display", "flex");
                } else if (this.value == 3){
                    $(".name-field").css("display", "none");
                    $(".number-field").css("display", "flex");
                    $(".email-field").css("display", "none");
                }
            });
        }
    ...
    **/
    ...
    openclose: function () {
        ...
        jQuery('[data-reqired-opener]').change(function () {
            if(this.checked){
                jQuery(this).closest('[data-reqired-parent]').find('[data-required-slide]').slideDown();
            }
            else {
                jQuery(this).closest('[data-reqired-parent]').find('[data-required-slide]').slideUp();
            }
        });
  ...
  **/
   ...
   **/
    ...
    rangebar: function () {
        jQuery('#question-contact-info-font-slider').bootstrapSlider({
            formatter: function(value) {
                jQuery('.question-contact-info-font').val(value);
                jQuery(".cta-btn").css({
                    'font-size': value,
                });
                return   value +'px';
            ...
            min: 8,
            max: 40,
            value: jQuery('.question-contact-info-font').val(),
            tooltip: 'always',
            tooltip_position: 'bottom'
        });

        jQuery('#question-contact-info-icon-size-slider').bootstrapSlider({
            formatter: function(value) {
                jQuery('.question-contact-info-icon-size').val(value);
            ...
            min: 10,
            max: 28,
            value: jQuery('.question-contact-info-icon-size').val(),
            tooltip: 'always',
            tooltip_position: 'bottom'
        });
    ...
    **/
    ...
    color_picker: function () {
        ...
        $('#question-contact-info-clr-icon').click(function () {
            var name = ".question-contact-info-icon-clr";
        ...
        $('#question-contact-info-icon-clr').ColorPicker({
            color: "#ffffff",
            flat: true,
            opacity:true,
            width: 203,
            ...
            onChange: function (hsb, hex, rgb, rgba) {
                ...
                $(".question-contact-info-icon-clr .color-box__r .color-box__rgb").val(rgb.r);
                $(".question-contact-info-icon-clr .color-box__g .color-box__rgb").val(rgb.g);
                $(".question-contact-info-icon-clr .color-box__b .color-box__rgb").val(rgb.b);
                $(".question-contact-info-icon-clr .color-box__hex-block").val('#'+hex);
                $('#question-contact-info-clr-icon').find('.last-selected__box').css('backgroundColor', rgba_fn);
                $('#question-contact-info-clr-icon').find('.last-selected__code').text('#'+hex);
    ...
    **/
    ...
    contact_setup: function () {
        jQuery('.add-input-button').click(function (e){
            e.preventDefault();
   ...
   * */
    ...
    **/
    ...
    init: function() {
        ...
        contact_info_overlay.customscroll();
        contact_info_overlay.selecticon();
        contact_info_overlay.rangebar();
        contact_info_overlay.color_picker();
        contact_info_overlay.allCustomSelect();
        contact_info_overlay.outsideclick();
        contact_info_overlay.drag_feature();
        contact_info_overlay.contact_setup();
        contact_info_overlay.color_picker_dropdown();
        contact_info_overlay.quick_access();
        contact_info_overlay.outside_hover();
        contact_info_overlay.tooltip();
        contact_info_overlay.farola_editor();
    },
};

$(document).ready(function () {
    ...
    select2js_sec_protocol.select2({
        ...
        jQuery('.select2js__sec-protocol-parent .select2-selection__rendered').css('opacity', '0');
    }).on('select2:open', function() {
        jQuery('.select2js__sec-protocol-parent .select2-results__options').css('pointer-events', 'none');
        setTimeout(function() {
            jQuery('.select2js__sec-protocol-parent .select2-results__options').css('pointer-events', 'auto');
        }, 300);
        jQuery('.select2js__sec-protocol-parent .select2-dropdown').hide();
        jQuery('.select2js__sec-protocol-parent .select2-dropdown').css({'display': 'block', 'opacity': '1', 'transform': 'scale(1, 1)'});
        jQuery('.select2js__sec-protocol-parent .select2-selection__rendered').hide();
    }).on('select2:closing', function(e) {
        if(!amIclosing) {
            e.preventDefault();
            amIclosing = true;
            jQuery('.select2js__sec-protocol-parent .select2-dropdown').attr('style', '');
            setTimeout(function () {
                jQuery('.select2js__sec-protocol').select2("close");
            }, 200);
        } else {
            amIclosing = false;
        }
    }).on('select2:close', function() {
        jQuery('.select2js__sec-protocol-parent .select2-selection__rendered').show();
        jQuery('.select2js__sec-protocol-parent .select2-results__options').css('pointer-events', 'auto');
    });
    ...
    select2js_answer_msgtype.select2({
        ...
        jQuery('.msgtype-dynamic-anwser-parent .select2-selection__rendered').css('opacity', '0');
    }).on('select2:open', function() {
        jQuery('.msgtype-dynamic-anwser-parent .select2-results__options').css('pointer-events', 'none');
        setTimeout(function() {
            jQuery('.msgtype-dynamic-anwser-parent .select2-results__options').css('pointer-events', 'auto');
        }, 300);
        jQuery('.msgtype-dynamic-anwser-parent .select2-dropdown').hide();
        jQuery('.msgtype-dynamic-anwser-parent .select2-dropdown').css({'display': 'block', 'opacity': '1', 'transform': 'scale(1, 1)'});
        jQuery('.msgtype-dynamic-anwser-parent .select2-selection__rendered').hide();
    }).on('select2:closing', function(e) {
        if(!amIclosing) {
            e.preventDefault();
            amIclosing = true;
            jQuery('.msgtype-dynamic-anwser-parent .select2-dropdown').attr('style', '');
            setTimeout(function () {
                jQuery('.msgtype-dynamic-anwser').select2("close");
            }, 200);
        } else {
            amIclosing = false;
        }
    }).on('select2:close', function() {
        jQuery('.msgtype-dynamic-anwser-parent .select2-selection__rendered').show();
        jQuery('.msgtype-dynamic-anwser-parent .select2-results__options').css('pointer-events', 'auto');
    });
    ...
    select2js_answer_submsg.select2({
        ...
        dropdownParent: $('.submsg-dynamic-anwser-parent')
            ...
            jQuery('.submsg-dynamic-anwser-parent .select2-selection__rendered').css('opacity', '0');
        }).on('select2:open', function() {
            jQuery('.submsg-dynamic-anwser-parent .select2-results__options').css('pointer-events', 'none');
            setTimeout(function() {
                jQuery('.submsg-dynamic-anwser-parent .select2-results__options').css('pointer-events', 'auto');
            }, 300);
            jQuery('.submsg-dynamic-anwser-parent .select2-dropdown').hide();
            jQuery('.submsg-dynamic-anwser-parent .select2-dropdown').css({'display': 'block', 'opacity': '1', 'transform': 'scale(1, 1)'});
            jQuery('.submsg-dynamic-anwser-parent .select2-selection__rendered').hide();
        }).on('select2:closing', function(e) {
            if(!amIclosing) {
                e.preventDefault();
                amIclosing = true;
                jQuery('.submsg-dynamic-anwser-parent .select2-dropdown').attr('style', '');
                setTimeout(function () {
                    jQuery('.submsg-dynamic-anwser').select2("close");
                }, 200);
            } else {
                amIclosing = false;
            }
        }).on('select2:close', function() {
            jQuery('.submsg-dynamic-anwser-parent .select2-selection__rendered').show();
            jQuery('.submsg-dynamic-anwser-parent .select2-results__options').css('pointer-events', 'auto');
        })
    ...
    jQuery('.sender-email-toggle').click(function (e) {
        e.preventDefault();
        if(jQuery(this).parents('.sender-email-parent').hasClass('active')) {
            jQuery(this).parents('.sender-email-parent').find('.sender-email-list-dropdown').attr('style', '');
            jQuery(this).parents('.sender-email-parent').removeClass('active');
        } else {
            jQuery(this).parents('.sender-email-parent').addClass('active');
            jQuery(this).parents('.sender-email-parent').find('.sender-email-list-dropdown').css({'display': 'block', 'opacity': '1', 'transform': 'scaleX(1) scaleY(1)'});
        }
    });

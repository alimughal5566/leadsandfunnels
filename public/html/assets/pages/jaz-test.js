...
var text_field_overlay = {

    overlay_select_list : [
        {selecter:".textfield-icon-type", parent:".textfield-input-icon-parent"},
        {selecter:".textfield-message-type", parent:".textfield-input-message-parent"},
        {selecter:".textfield-icon-type-long", parent:".textfield-input-icon-parent-long"},
        {selecter:".textfield-message-type-long", parent:".textfield-input-message-parent-long"},
    ],
    ...
    **/
    ...
    allCustomSelect: function () {
        var selectlist = text_field_overlay.overlay_select_list;
        for(var i = 0; i < selectlist.length; i++){
            text_field_overlay.initCustomSelect(selectlist[i].selecter,selectlist[i].parent);
        }
    },
    ...
    **/
    ...
    openclose: function () {
        ...
        jQuery('.text-field-overlay .actions-button__link_close-funnels').click(function (e) {
           e.preventDefault();
           jQuery('body').removeClass('text-overlay-active');
        });

        jQuery('.text-field-overlay-iframe .actions-button__link_close-funnels').click(function (e) {
            e.preventDefault();
            jQuery('body').removeClass('text-overlay-iframe-active');
        });
    },
  ...
  **/
   ...
   **/
    ...
    rangebar: function () {
        jQuery('#textfield-font-slider').bootstrapSlider({
            formatter: function(value) {
                jQuery('.textfield-font').val(value);
                jQuery(".cta-btn").css({
                    'font-size': value,
                });
                return   value +'px';
            ...
            min: 8,
            max: 38,
            value: jQuery('.textfield-font').val(),
            tooltip: 'always',
            tooltip_position: 'bottom'
        });

        jQuery('#text-field-icon-size-slider').bootstrapSlider({
            formatter: function(value) {
                jQuery('.text-field-icon-size').val(value);
            ...
            min: 10,
            max: 28,
            value: jQuery('.text-field-icon-size').val(),
            tooltip: 'hide',
            tooltip_position: 'bottom'
        });

        jQuery('#textfield-font-slider-long').bootstrapSlider({
            formatter: function(value) {
                jQuery('.textfield-font-long').val(value);
                return   value +'px';
            },
            min: 8,
            max: 48,
            value: jQuery('.textfield-font-long').val(),
            tooltip: 'always',
            tooltip_position: 'bottom'
        });

        jQuery('#text-field-icon-size-slider-long').bootstrapSlider({
            formatter: function(value) {
                jQuery('.text-field-icon-size-long').val(value);
                return   value +'px';
            },
            min: 9,
            max: 40,
            value: jQuery('.text-field-icon-size-long').val(),
            tooltip: 'hide',
            tooltip_position: 'bottom'
        });
    },
  ...
  **/
    ...
    question_setting: function () {
        jQuery('.question-heading').on('froalaEditor.keyup', function (e, editor, keyupEvent) {
            var html = jQuery(this).froalaEditor('html.get');
            var text = jQuery(html).text();
            jQuery('.question__title h1').html(text);
        });

        jQuery('.description-text').on('froalaEditor.keyup', function (e, editor, keyupEvent) {
            var html = jQuery(this).froalaEditor('html.get');
            var text = jQuery(html).text();
            jQuery('.question__text').html(text);
        });

        jQuery('.label-form-control').on('keyup', function () {
           var text = jQuery(this).val();
            jQuery('.input-label').html(text);
        });

        jQuery('.btn-value-text').on('keyup', function () {
            var text = jQuery(this).val();
            jQuery('.cta-btn').html(text);
        });

        jQuery('.hide-checkbox-field').change(function () {
            if(this.checked){
    ...
    **/
    ...
    init: function() {
        ...
        text_field_overlay.openclose();
        text_field_overlay.customscroll();
        text_field_overlay.selecticon();
        text_field_overlay.rangebar();
        text_field_overlay.color_picker();
        text_field_overlay.allCustomSelect();
        text_field_overlay.outsideclick();
        text_field_overlay.question_setting();
    },
};

jQuery(document).ready(function() {
    text_field_overlay.init();

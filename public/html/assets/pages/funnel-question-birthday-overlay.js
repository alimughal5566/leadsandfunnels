...
var question_birthday_overlay = {
    ...
    overlay_select_list : [
        {selecter:".question-birthday-icon-type", parent:".question-birthday-icon-type-parent"},
        {selecter:".question-birthday-message", parent:".question-birthday-message-parent"},
    ...
    **/
    ...
    allCustomSelect: function () {
        ...
        for(var i = 0; i < selectlist.length; i++){
            question_birthday_overlay.initCustomSelect(selectlist[i].selecter,selectlist[i].parent);
        }
    },
  ...
  **/
   ...
   **/
    ...
    rangebar: function () {
        jQuery('#question-birthday-font-slider').bootstrapSlider({
            formatter: function(value) {
                jQuery('.question-birthday-font').val(value);
                jQuery(".cta-btn").css({
                    'font-size': value,
                });
                return   value +'px';
            ...
            min: 8,
            max: 40,
            value: jQuery('.question-birthday-font').val(),
            tooltip: 'always',
            tooltip_position: 'bottom'
        });

        jQuery('#question-birthday-icon-size-slider').bootstrapSlider({
            formatter: function(value) {
                jQuery('.question-birthday-icon-size').val(value);
            ...
            min: 10,
            max: 28,
            value: jQuery('.question-birthday-icon-size').val(),
            tooltip: 'always',
            tooltip_position: 'bottom'
        });

        jQuery('.birthday-year-old').bootstrapSlider({
            formatter: function(value) {
                jQuery('.birthday-select2js__slide__minimum-val').html(value);
            },
            min: 0,
            max: 100,
            value: $('.birthday-year-old').val(),
            tooltip: 'false',
        });


        jQuery('.birthday-year-slider').bootstrapSlider({
            formatter: function(value) {
                jQuery('.birthday-select2js__slide__current-year').html(value);
            },
            min: 0,
            max: 100,
            value: $('.birthday-year-slider').val(),
            tooltip: 'false',
        });
    ...
    **/
    ...
    color_picker: function () {
        ...
        $('#question-birthday-clr-icon').click(function () {
            var name = ".question-birthday-icon-clr";
        ...
        $('#question-birthday-icon-clr').ColorPicker({
            color: "#ffffff",
            flat: true,
            opacity:true,
            width: 203,
            ...
            onChange: function (hsb, hex, rgb, rgba) {
                ...
                $(".question-birthday-icon-clr .color-box__r .color-box__rgb").val(rgb.r);
                $(".question-birthday-icon-clr .color-box__g .color-box__rgb").val(rgb.g);
                $(".question-birthday-icon-clr .color-box__b .color-box__rgb").val(rgb.b);
                $(".question-birthday-icon-clr .color-box__hex-block").val('#'+hex);
                $('#question-birthday-clr-icon').find('.last-selected__box').css('backgroundColor', rgba_fn);
                $('#question-birthday-clr-icon').find('.last-selected__code').text('#'+hex);
   ...
   * */
    ...
    **/
    ...
    init: function() {
        ...
        question_birthday_overlay.openclose();
        question_birthday_overlay.customscroll();
        question_birthday_overlay.selecticon();
        question_birthday_overlay.rangebar();
        question_birthday_overlay.color_picker();
        question_birthday_overlay.allCustomSelect();
        question_birthday_overlay.outsideclick();
        question_birthday_overlay.birthday_select();
        question_birthday_overlay.tooltip();
        question_birthday_overlay.color_picker_dropdown();
        question_birthday_overlay.quick_access();
        question_birthday_overlay.outside_hover();
        question_birthday_overlay.farola_editor();
    },
};

...
var dropdown_overlay = {
    ...
    overlay_select_list : [
        {selecter:".question-dropdown-icon-type", parent:".question-dropdown-input-icon-parent"},
        {selecter:".question-dropdown-message", parent:".question-dropdown-message-parent"},
    ],
    ...
    **/
    ...
    allCustomSelect: function () {
        var selectlist = dropdown_overlay.overlay_select_list;
        for(var i = 0; i < selectlist.length; i++){
            dropdown_overlay.initCustomSelect(selectlist[i].selecter,selectlist[i].parent);
        }
    },
   ...
   **/
    ...
    rangebar: function () {
        jQuery('#question-dropdown-font-slider').bootstrapSlider({
            formatter: function(value) {
                jQuery('.question-dropdown-font').val(value);
                jQuery(".cta-btn").css({
                    'font-size': value,
                });
                return   value +'px';
            ...
            min: 8,
            max: 40,
            value: jQuery('.question-dropdown-font').val(),
            tooltip: 'always',
            tooltip_position: 'bottom'
        });

        jQuery('#question-dropdown-icon-size-slider').bootstrapSlider({
            formatter: function(value) {
                jQuery('.question-dropdown-icon-size').val(value);
            ...
            min: 10,
            max: 28,
            value: jQuery('.question-dropdown-icon-size').val(),
            tooltip: 'hide',
            tooltip_position: 'bottom'
        });
    ...
    **/
    ...
    color_picker: function () {
        ...
        $('#question-dropdown-clr-icon').click(function () {
            var name = ".question-dropdown-icon-clr";
        ...
        $('#question-dropdown-icon-clr').ColorPicker({
            color: "#ffffff",
            flat: true,
            opacity:true,
            width: 203,
            ...
            onChange: function (hsb, hex, rgb, rgba) {
                ...
                $(".question-dropdown-icon-clr .color-box__r .color-box__rgb").val(rgb.r);
                $(".question-dropdown-icon-clr .color-box__g .color-box__rgb").val(rgb.g);
                $(".question-dropdown-icon-clr .color-box__b .color-box__rgb").val(rgb.b);
                $(".question-dropdown-icon-clr .color-box__hex-block").val('#'+hex);
                $('#question-dropdown-clr-icon').find('.last-selected__box').css('backgroundColor', rgba_fn);
                $('#question-dropdown-clr-icon').find('.last-selected__code').text('#'+hex);
   ...
   * */
    ...
    **/
    ...
    init: function() {
        ...
        dropdown_overlay.openclose();
        dropdown_overlay.customscroll();
        dropdown_overlay.selecticon();
        dropdown_overlay.rangebar();
        dropdown_overlay.color_picker();
        dropdown_overlay.allCustomSelect();
        dropdown_overlay.outsideclick();
        dropdown_overlay.menugroup();
        dropdown_overlay.color_picker_dropdown();
        dropdown_overlay.quick_access();
        dropdown_overlay.tooltip();
        dropdown_overlay.outside_hover();
        dropdown_overlay.farola_editor();
    },
};

jQuery(document).ready(function() {
    dropdown_overlay.init();
});

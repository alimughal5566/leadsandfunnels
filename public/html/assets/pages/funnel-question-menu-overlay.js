...
var question_menu_overlay = {

    overlay_select_list : [
        {selecter:".question-menu-icon-type", parent:".question-menu-input-icon-parent"},
        {selecter:".question-menu-message", parent:".question-menu-message-parent"},
    ],
    ...
    **/
    ...
    allCustomSelect: function () {
        var selectlist = question_menu_overlay.overlay_select_list;
        for(var i = 0; i < selectlist.length; i++){
            question_menu_overlay.initCustomSelect(selectlist[i].selecter,selectlist[i].parent);
        }
    },
    ...
    **/
    ...
    openclose: function () {
        ...
        jQuery('body').on('change', '.automatic-checkbox', function(){
            if(this.checked){
   ...
   **/
    ...
    rangebar: function () {
        jQuery('#question-menu-font-slider').bootstrapSlider({
            formatter: function(value) {
                jQuery('.question-menu-font').val(value);
                jQuery(".cta-btn").css({
                    'font-size': value,
                });
                return   value +'px';
            ...
            min: 8,
            max: 40,
            value: jQuery('.question-menu-font').val(),
            tooltip: 'always',
            tooltip_position: 'bottom'
        });

        jQuery('#question-menu-icon-size-slider').bootstrapSlider({
            formatter: function(value) {
                jQuery('.question-menu-icon-size').val(value);
            ...
            min: 10,
            max: 28,
            value: jQuery('.question-menu-icon-size').val(),
            tooltip: 'always',
            tooltip_position: 'bottom'
        });
    ...
    **/
    ...
    color_picker: function () {
        ...
        $('#question-menu-clr-icon').click(function () {
            var name = ".question-menu-icon-clr";
        ...
        $('#question-menu-icon-clr').ColorPicker({
            color: "#ffffff",
            flat: true,
            opacity:true,
            width: 203,
            ...
            onChange: function (hsb, hex, rgb, rgba) {
                ...
                $(".question-menu-icon-clr .color-box__r .color-box__rgb").val(rgb.r);
                $(".question-menu-icon-clr .color-box__g .color-box__rgb").val(rgb.g);
                $(".question-menu-icon-clr .color-box__b .color-box__rgb").val(rgb.b);
                $(".question-menu-icon-clr .color-box__hex-block").val('#'+hex);
                $('#question-menu-clr-icon').find('.last-selected__box').css('backgroundColor', rgba_fn);
                $('#question-menu-clr-icon').find('.last-selected__code').text('#'+hex);
   ...
   **/
    ...
    **/
    ...
    init: function() {
        ...
        question_menu_overlay.openclose();
        question_menu_overlay.customscroll();
        question_menu_overlay.selecticon();
        question_menu_overlay.rangebar();
        question_menu_overlay.color_picker();
        question_menu_overlay.allCustomSelect();
        question_menu_overlay.outsideclick();
        question_menu_overlay.menugroup();
        question_menu_overlay.outside_hover();
        question_menu_overlay.quick_access();
        question_menu_overlay.color_picker_dropdown();
        question_menu_overlay.tooltip();
        question_menu_overlay.farola_editor();
    },
};

jQuery(document).ready(function() {
    question_menu_overlay.init();
});

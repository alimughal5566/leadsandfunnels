    ...
    **/
    ...
    openclose: function () {
        ...
        jQuery('.fb-tab__link').click(function(e){
            ...
            if(jQuery(this).hasClass('long-text')){
                jQuery('.tab-content').addClass('long-tab-active');
            }
            else {
                jQuery('.tab-content').removeClass('long-tab-active');
            }
        });
   ...
   * */
    ...
    **/
    ...
    init: function() {
        ...
        text_field_overlay.color_picker_dropdown();
        text_field_overlay.quick_access();
        text_field_overlay.outside_hover();
        text_field_overlay.tooltip();
        text_field_overlay.farola_editor();
    },
};

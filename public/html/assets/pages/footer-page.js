$(document).ready(function () {
    ...
    $('.action__link_edit').click(function () {
        $(this).hide();
        $(this).closest('.lp-panel').addClass('lp-panel-active');
        $(this).closest('.lp-panel').find('.line-input').prop( "disabled", false );
        $(this).closest('.lp-panel').find(".action__link_cancel").css({display: "flex"});
        $(this).closest('.lp-panel').find('.collapse-box').slideDown(function () {
            $(this).closest('.lp-panel').find('.collapse-next-input').focus();
        });
    });
    $('.action__link_cancel').click(function () {
        $(this).closest('.lp-panel').removeClass('lp-panel-active');
        ...
        $(this).closest('.lp-panel').find('.collapse-box').slideUp(function () {
            $(this).closest('.lp-panel').find('.collapse-next-input').focus();
        });
    });

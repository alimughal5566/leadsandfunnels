...
(function ($) {
    $(document).ready(function() {
        ...
        var mk_mcscroll_body = $('.quick-scroll').mCustomScrollbar({
        ...
        $('.select2__loc').select2({
            ...
            jQuery('.select2__loc-parent .select2-dropdown').css({'display': 'block', 'opacity': '1', 'transform': 'scale(1, 1)'});
        ...
        $('.select2js__codetype').select2({
            minimumResultsForSearch: -1,
            width: '100%', // need to override the changed default
            dropdownParent: $('.select2js__codetype-parent')
        }).on('select2:openning', function() {
            jQuery('.select2js__codetype-parent .select2-selection__rendered').css('opacity', '0');
        }).on('select2:open', function() {
            jQuery('.select2js__codetype-parent .select2-results__options').css('pointer-events', 'none');
            setTimeout(function() {
                jQuery('.select2js__codetype-parent .select2-results__options').css('pointer-events', 'auto');
            }, 300);
            jQuery('.select2js__codetype-parent .select2-dropdown').hide();
            jQuery('.select2js__codetype-parent .select2-dropdown').css({'display': 'block', 'opacity': '1', 'transform': 'scale(1, 1)'});
            jQuery('.select2js__codetype-parent .select2-selection__rendered').hide();
        }).on('select2:closing', function(e) {
            if(!amIclosing) {
                e.preventDefault();
                amIclosing = true;
                jQuery('.select2js__codetype-parent .select2-dropdown').attr('style', '');
                setTimeout(function () {
            ...
            jQuery('.select2js__codetype-parent .select2-selection__rendered').show();
            jQuery('.select2js__codetype-parent .select2-results__options').css('pointer-events', 'none');
        });
        ...
        $('.select2js__pixelplacement').select2({
            ...
            jQuery('.select2js__pixelplacement-parent .select2-dropdown').css({'display': 'block', 'opacity': '1', 'transform': 'scale(1, 1)'});
        ...
        $('.select2js__trackoption').select2({
            ...
            if($('#tracking_options').val() == 3){
                ...
                $(".question_options").slideDown(function (){
                    mk_mcscroll_body.mCustomScrollbar("scrollTo", $('#ka-dd-toggle').position().top);
                });
            }
        }).on('select2:openning', function() {
            ...
            jQuery('.select2js__trackoption-parent .select2-dropdown').css({'display': 'block', 'opacity': '1', 'transform': 'scale(1, 1)'});
        ...
        $('#pixel_type,#pixel_placement').on("change", function(e) {
    ...
    //    js validation
        ...
        var valid_obj = $('#dd-code-popup').validate({
            rules: {
                pixel_name: {
                    required: true
                },
...
function pixel_extra_fields(type, placement, elem){
    ...
    if(type == FACEBOOK_PIXEL && placement == PAGE_FUNNEL){
        ...
        $('.tracking_options').find('.displayText').html( $('[data-name="tracking_options"]').attr('data-default-label') );
        if($('#tracking_options').val() == 3){
        ...
        $(".tracking_options").slideDown();
        $('#tracking_options').val( PIXEL_ACTION_LEAD );
        console.log($('.tracking_options ul li[data-value="'+PIXEL_ACTION_LEAD+'"]'));
...
function addPixelCode() {
    ...
    $("#model_pixel_code").find("div.pixel_other").slideUp();
...
function editPixelCode(elem) {
    ...
    $("#model_pixel_code").find('#pixel_position').val(elem.attr('data-pixel_position'));
...
function deletePixelCode(elem) {
    ...
    $.ajax( {
        type : "POST",
        data: "id="+$("#id_confirmPixelDelete").val()+"&client_id="+$("#client_id_confirmPixelDelete").val(),
        dataType:"json",
        ...
        success : function(d) {
            if (d.status == "success") {
                ...
                notification.error(notification_container, 'Unable to delete code');
            }
...
function CodeName_List() {
    ...
    if(length == 0) {
        ...
        $('.pixel-panel .message-block').hide();
    }
}

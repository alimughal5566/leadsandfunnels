...
var slider_overlay = {
    ...
    overlay_select_list : [
        {selecter:".slider-icon-type", parent:".slider-input-icon-parent"},
        {selecter:".slider-message-type", parent:".slider-input-message-parent"},
        {selecter:".fb-select_unit", parent:".fb-select_unit-wrap"},
        {selecter:".fb-select_by", parent:".fb-select_by-wrap"},
        {selecter:".fb-select_start", parent:".fb-select_start-wrap"},
        {selecter:".fb-select_unit-1", parent:".fb-select_unit-wrap-1"},
        {selecter:".fb-select_by-1", parent:".fb-select_by-wrap-1"},
        {selecter:".fb-select_start-1", parent:".fb-select_start-wrap-1"},
    ],
    ...
    **/
    ...
    allCustomSelect: function () {
        var selectlist = slider_overlay.overlay_select_list;
        for(var i = 0; i < selectlist.length; i++){
            slider_overlay.initCustomSelect(selectlist[i].selecter,selectlist[i].parent);
        }
    },
  ...
  **/
   ...
   **/
    ...
    rangebar: function () {
        jQuery('#slider-font-slider').bootstrapSlider({
            formatter: function(value) {
                jQuery('.slider-font').val(value);
                jQuery(".cta-btn").css({
                    'font-size': value,
                });
                return   value +'px';
            ...
            min: 8,
            max: 38,
            value: jQuery('.slider-font').val(),
            tooltip: 'always',
            tooltip_position: 'bottom'
        });

        jQuery('#slider-field-icon-size-slider').bootstrapSlider({
            formatter: function(value) {
                jQuery('.slider-field-icon-size').val(value);
            ...
            min: 10,
            max: 28,
            value: jQuery('.slider-field-icon-size').val(),
            tooltip: 'hide',
            tooltip_position: 'bottom'
        });
    ...
    **/
    ...
    color_picker: function () {
        ...
        $('#slider-clr-icon').click(function () {
            var name = ".slider-icon-clr";
        ...
        $('#slider-icon-clr').ColorPicker({
            ...
            onChange: function (hsb, hex, rgb, rgba) {
                ...
                $(".slider-icon-clr .color-box__r .color-box__rgb").val(rgb.r);
                $(".slider-icon-clr .color-box__g .color-box__rgb").val(rgb.g);
                $(".slider-icon-clr .color-box__b .color-box__rgb").val(rgb.b);
                $(".slider-icon-clr .color-box__hex-block").val('#'+hex);
                $('#slider-clr-icon').find('.last-selected__box').css('backgroundColor', rgba_fn);
                $('#slider-clr-icon').find('.last-selected__code').text('#'+hex);
    ...
    **/
    ...
    init: function() {
        ...
        slider_overlay.openclose();
        slider_overlay.customscroll();
        slider_overlay.selecticon();
        slider_overlay.rangebar();
        slider_overlay.color_picker();
        slider_overlay.allCustomSelect();
        slider_overlay.outsideclick();
        slider_overlay.dragable();
        slider_overlay.addValues();
        slider_overlay.tooltip();
        slider_overlay.quick_access();
        slider_overlay.outside_hover();
        slider_overlay.color_picker_dropdown();
        slider_overlay.farola_editor();
    },
};

window.selectItems = {
    ...
    'select-answer-style' :[
        ...
        {
            id:1,
            text:'<div class="select2_style">Select answer style: <span>Select Fields</span></div>',
            title:'Select Fields'
        },
        {
            id:2,
            text:'<div class="select2_style">Select answer style: <span>Text Fields</span></div>',
            title:'Select Fields'
        },
        {
            id:3,
            text:'<div class="select2_style">Select answer style: <span>Range Fields</span></div>',
            title:'Select Fields'
        }
    ],
    ...
    'select-time-style' :[
        {
            id:0,
            text:'<div class="select2_style"><span>Select Time Format</span></div>',
            title:'Select Time Format'
        },
        {
            id:1,
            text:'<div class="select2_style"><span class="select-title">Time Format:</span> <span class="time">8:45 | PM </span><span>HH : MM | XM</span></div>',
            title:'Select Time Format'
        },
        {
            id:2,
            text:'<div class="select2_style"><span class="select-title">Time Format:</span><span class="time">8:45:30 | PM </span><span>HH : MM : SS | XM</span></div>',
            title:'Select Time Format'
        },
        {
            id:3,
            text:'<div class="select2_style"><span class="select-title">Time Format:</span><span class="time">20:45</span><span>HH : MM</span></div>',
            title:'Select Time Format'
        },
        {
            id:4,
            text:'<div class="select2_style"><span class="select-title">Time Format:</span><span class="time">20:45:30</span><span>HH : MM : SS</span></div>',
            title:'Select Time Format'
        },
    ],
};

var question_timepicker_overlay = {

    overlay_select_list : [
        {selecter:".question-timepicker-icon-type", parent:".question-timepicker-icon-type-parent"},
        {selecter:".question-timepicker-message", parent:".question-timepicker-message-parent"},
        {selecter:".select-answer-style", parent:".select-answer-style-parent"},
        {selecter:".select-time-style", parent:".select-time-style-parent"},
    ],
    ...
    **/
    ...
    allCustomSelect: function () {
        var selectlist = question_timepicker_overlay.overlay_select_list;
        for(var i = 0; i < selectlist.length; i++){
            question_timepicker_overlay.initCustomSelect(selectlist[i].selecter,selectlist[i].parent);
        }
    },
    ...
    **/
    ...
    initCustomSelect: function (selecter,parent) {
        ...
        if(selectorClass == 'select-time-style') {
            $(selecter).val(1).change();
        }
    },
  ...
  **/
   ...
   **/
    ...
    rangebar: function () {
        jQuery('#question-timepicker-font-slider').bootstrapSlider({
            formatter: function(value) {
                jQuery('.question-timepicker-font').val(value);
                jQuery(".cta-btn").css({
                    'font-size': value,
                });
                return   value +'px';
            ...
            min: 8,
            max: 40,
            value: jQuery('.question-timepicker-font').val(),
            tooltip: 'always',
            tooltip_position: 'bottom'
        });

        jQuery('#question-timepicker-icon-size-slider').bootstrapSlider({
            formatter: function(value) {
                jQuery('.question-timepicker-icon-size').val(value);
            ...
            min: 10,
            max: 28,
            value: jQuery('.question-timepicker-icon-size').val(),
            tooltip: 'always',
            tooltip_position: 'bottom'
        });
    ...
    **/
    ...
    color_picker: function () {
        ...
        $('#question-timepicker-clr-icon').click(function () {
            var name = ".question-timepicker-icon-clr";
        ...
        $('#question-timepicker-icon-clr').ColorPicker({
            color: "#ffffff",
            flat: true,
            opacity:true,
            width: 203,
            ...
            onChange: function (hsb, hex, rgb, rgba) {
                ...
                $(".question-timepicker-icon-clr .color-box__r .color-box__rgb").val(rgb.r);
                $(".question-timepicker-icon-clr .color-box__g .color-box__rgb").val(rgb.g);
                $(".question-timepicker-icon-clr .color-box__b .color-box__rgb").val(rgb.b);
                $(".question-timepicker-icon-clr .color-box__hex-block").val('#'+hex);
                $('#question-timepicker-clr-icon').find('.last-selected__box').css('backgroundColor', rgba_fn);
                $('#question-timepicker-clr-icon').find('.last-selected__code').text('#'+hex);
    ...
    outsideclick: function () {
        jQuery(document).click(function(e) {
            ...
            if (!jQuery(e.target).hasClass("timepicker-select2js__opener") && jQuery(e.target).parents(".timepicker-select2js__slide__body-area").length === 0) {
                jQuery(".timepicker-select2js").removeClass('slide-active');
            }
    ...
    **/
    ...
    timepicker_select: function () {
        jQuery('.timepicker-select2js__opener').click(function (e){
            e.preventDefault();
            if(jQuery(this).parent('.timepicker-select2js').hasClass('slide-active')) {
                jQuery(this).parent('.timepicker-select2js').removeClass('slide-active');
            }

            else {
                jQuery('.timepicker-select2js').removeClass('slide-active');
                jQuery(this).parent('.timepicker-select2js').addClass('slide-active');
            }
        });

        jQuery('.timepicker-select2js__slide__label').click(function (e){
            e.preventDefault();
            jQuery(this).parents('.timepicker-select2js').toggleClass('slide-active');
        });
    },
   ...
   * */
    ...
    **/
    ...
    init: function() {
        ...
        question_timepicker_overlay.openclose();
        question_timepicker_overlay.customscroll();
        question_timepicker_overlay.selecticon();
        question_timepicker_overlay.rangebar();
        question_timepicker_overlay.color_picker();
        question_timepicker_overlay.allCustomSelect();
        question_timepicker_overlay.outsideclick();
        question_timepicker_overlay.timepicker_select();
        question_timepicker_overlay.tooltip();
        question_timepicker_overlay.color_picker_dropdown();
        question_timepicker_overlay.quick_access();
        question_timepicker_overlay.outside_hover();
        question_timepicker_overlay.farola_editor();
    },
};

jQuery(document).ready(function() {
    question_timepicker_overlay.init();
});

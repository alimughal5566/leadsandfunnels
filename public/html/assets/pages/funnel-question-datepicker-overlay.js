window.selectItems = {
    ...
    'select-answer-style' :[
        {
            id:0,
            text:'<div class="select2_style">SELECT ANSWER STYLE</div>',
            title:'Select Fields'
        },
        {
            id:1,
            text:'<div class="select2_style"><span class="select-title">Select answer style:select-title </span><span>Calendar</span></div>',
            title:'Select Fields'
        },
        {
            id:2,
            text:'<div class="select2_style"><span class="select-title">Select answer style: </span><span>Input Field</span></div>',
            title:'Select Fields'
        },
        {
            id:3,
            text:'<div class="select2_style"><span class="select-title">Select answer style: </span><span>Select Fields</span></div>',
            title:'Select Fields'
        }
    ],
    ...
    'select-calendar-style' :[
        {
            id:0,
            text:'<div class="select2_style">CALENDAR ASNWER FORMAT</div>',
            title:'Select Fields'
        },
        {
            id:1,
            text:'<div class="select2_style"><span class="select-title">Calendar answer format: </span><span>Single Date</span></div>',
            title:'Select Fields'
        },
        {
            id:2,
            text:'<div class="select2_style"><span class="select-title">Calendar answer format: </span><span>Multiple Dates</span></div>',
            title:'Select Fields'
        },
        {
            id:3,
            text:'<div class="select2_style"><span class="select-title">Calendar answer format: </span><span>Date Range</span></div>',
            title:'Select Fields'
        }
    ],
    ...
    'select-date-style' :[
        {
            id:0,
            text:'<div class="select2_style">SELECT DATE FORMAT</div>',
            title:'Select Date Format'
        },
        {
            id:1,
            text:'<div class="select2_style"><span class="select-title">Date Format:</span> <span class="date">8:45 | PM </span><span>HH : MM | XM</span></div>',
            title:'Select Date Format'
        },
        {
            id:2,
            text:'<div class="select2_style"><span class="select-title">Date Format:</span><span class="date">8:45:30 | PM </span><span>HH : MM : SS | XM</span></div>',
            title:'Select Date Format'
        },
        {
            id:3,
            text:'<div class="select2_style"><span class="select-title">Date Format:</span><span class="date">20:45</span><span>HH : MM</span></div>',
            title:'Select Date Format'
        },
        {
            id:4,
            text:'<div class="select2_style"><span class="select-title">Date Format:</span><span class="date">20:45:30</span><span>HH : MM : SS</span></div>',
            title:'Select Date Format'
        },
    ],
    ...
    'select-year-style' :[
        {
            id:0,
            text:'<div class="select2_style">HOW FAR BACK YOU WANT TO DISPLAY</div>',
            title:'Select Date Format'
        },
        {
            id:1,
            text:'<div class="select2_style"><span class="select-title">How far back you want to display? </span> <span>20 years</span></div>',
            title:'How far back you want to display?'
        },
        {
            id:2,
            text:'<div class="select2_style"><span class="select-title">How far back you want to display? </span> <span>30 years</span></div>',
            title:'How far back you want to display?'
        },
        {
            id:3,
            text:'<div class="select2_style"><span class="select-title">How far back you want to display? </span> <span>40 years</span></div>',
            title:'How far back you want to display?'
        },
        {
            id:4,
            text:'<div class="select2_style"><span class="select-title">How far back you want to display? </span> <span>50 years</span></div>',
            title:'How far back you want to display?'
        },
    ],
};

var question_datepicker_overlay = {

    overlay_select_list : [
        {selecter:".question-datepicker-icon-type", parent:".question-datepicker-icon-type-parent"},
        {selecter:".question-datepicker-message", parent:".question-datepicker-message-parent"},
        {selecter:".select-answer-style", parent:".select-answer-style-parent"},
        {selecter:".select-calendar-style", parent:".select-calendar-style-parent"},
        {selecter:".select-date-style", parent:".select-date-style-parent"},
        {selecter:".select-year-style", parent:".select-year-style-parent"},
    ],
    ...
    **/
    ...
    allCustomSelect: function () {
        var selectlist = question_datepicker_overlay.overlay_select_list;
        for(var i = 0; i < selectlist.length; i++){
            question_datepicker_overlay.initCustomSelect(selectlist[i].selecter,selectlist[i].parent);
        }
    },
    ...
    **/
    ...
    initCustomSelect: function (selecter,parent) {
        ...
        if(selectorClass == 'select-answer-style') {
            $(selecter).val(1).change();
            $(selecter).on('change', function () {
                if(jQuery(this).val() == 1) {
                   jQuery('.calender-answer, .calendar-years, .calendar-date-style').show();
               }
                if(jQuery(this).val() == 2) {
                    jQuery('.calender-answer, .calendar-years').hide();
                    jQuery('.calendar-date-style').show();
               }
                if(jQuery(this).val() == 3) {
                    jQuery('.calender-answer, .calendar-date-style').hide();
                    jQuery('.calendar-years').show();
               }
            });
        }

        if(selectorClass == 'select-date-style') {
            $(selecter).val(1).change();
        }

        if(selectorClass == 'select-calendar-style') {
            $(selecter).val(1).change();
        }

        if(selectorClass == 'select-year-style') {
            $(selecter).val(1).change();
        }
    },
    ...
    **/
    ...
    openclose: function () {
        jQuery('[data-handler]').click(function(){
            ...
            jQuery(this).parents('[data-parent]').find('[data-handler-slide]').slideToggle();
        });

        jQuery('[data-opener]').change(function () {
            if(this.checked){
                jQuery(this).parents('[data-parent]').find('[data-slide]').slideDown();
                jQuery(this).parents('.fb-froala__init').froalaEditor('events.focus', true);
            }
            else {
                jQuery(this).parents('[data-parent]').find('[data-slide]').slideUp();
                jQuery(this).parents('.fb-froala__init').froalaEditor('events.focus', false);
            }
        });
  ...
  **/
    ...
    selecticon: function () {
        ...
        function fontAwsome() {
            ...
            jQuery.each(obj_fontawsome,function (index,value) {
                jQuery('.icons-list').append('<li><span class="icon-label"><span class="icon-wrap"><i class="icon ico-'+index+'"></i></span>' +
   ...
   **/
    ...
    rangebar: function () {
        jQuery('#question-datepicker-font-slider').bootstrapSlider({
            formatter: function(value) {
                jQuery('.question-datepicker-font').val(value);
                jQuery(".cta-btn").css({
                    'font-size': value,
                });
                return   value +'px';
            ...
            min: 8,
            max: 40,
            value: jQuery('.question-datepicker-font').val(),
            tooltip: 'always',
            tooltip_position: 'bottom'
        });

        jQuery('#question-datepicker-icon-size-slider').bootstrapSlider({
            formatter: function(value) {
                jQuery('.question-datepicker-icon-size').val(value);
            ...
            min: 10,
            max: 28,
            value: jQuery('.question-datepicker-icon-size').val(),
            tooltip: 'hide',
            tooltip_position: 'bottom'
        });
    },
    ...
    **/
    ...
    color_picker: function () {
        ...
        $('#question-datepicker-clr-icon').click(function () {
            var name = ".question-datepicker-icon-clr";
        ...
        $('#question-datepicker-icon-clr').ColorPicker({
            color: "#ffffff",
            flat: true,
            opacity:true,
            width: 203,
            ...
            onChange: function (hsb, hex, rgb, rgba) {
                ...
                $(".question-datepicker-icon-clr .color-box__r .color-box__rgb").val(rgb.r);
                $(".question-datepicker-icon-clr .color-box__g .color-box__rgb").val(rgb.g);
                $(".question-datepicker-icon-clr .color-box__b .color-box__rgb").val(rgb.b);
                $(".question-datepicker-icon-clr .color-box__hex-block").val('#'+hex);
                $('#question-datepicker-clr-icon').find('.last-selected__box').css('backgroundColor', rgba_fn);
                $('#question-datepicker-clr-icon').find('.last-selected__code').text('#'+hex);
    ...
    outsideclick: function () {
        jQuery(document).click(function(e) {
            ...
            if (!jQuery(e.target).hasClass("datepicker-select2js__opener") && jQuery(e.target).parents(".datepicker-select2js__slide__body-area").length === 0) {
                jQuery(".datepicker-select2js").removeClass('slide-active');
            }
   ...
   * */
    ...
    datePicker: function () {
        jQuery(".calendar-selector").flatpickr({
            inline: true,
            mode: "multiple",
            yearSelectorType: "static"
        });

        jQuery('.cur-year').on("keyup", function(e){
        ...
        jQuery('.range-selector').change(function(){
            if(jQuery(this).is(':checked')) {
                $(".calendar-selector").flatpickr({
                    inline: true,
                    mode: "range",
                });
            }
        ...
        jQuery(".btn-calendar-reset").click(function(e) {
            e.preventDefault();
            jQuery('.calendar-selector').flatpickr().clear();
            jQuery(".calendar-selector").flatpickr({
                inline: true,
                mode: "multiple",
                yearSelectorType: "static",
    ...
    **/
    ...
    init: function() {
        question_datepicker_overlay.addclassclick();
        question_datepicker_overlay.openclose();
        question_datepicker_overlay.customscroll();
        question_datepicker_overlay.selecticon();
        question_datepicker_overlay.rangebar();
        question_datepicker_overlay.color_picker();
        question_datepicker_overlay.allCustomSelect();
        question_datepicker_overlay.outsideclick();
        question_datepicker_overlay.tooltip();
        question_datepicker_overlay.color_picker_dropdown();
        question_datepicker_overlay.quick_access();
        question_datepicker_overlay.outside_hover();
        question_datepicker_overlay.datePicker();
    },
};

jQuery(document).ready(function() {
    question_datepicker_overlay.init();

...
$(function() {
    ...
    var customTooltips = function(tooltip) {
        ...
        if (tooltip.body) {
            ...
            titleLines.forEach(function(title) {
                ...
                innerHtml += '<tr class="chartjs-row"><td class="pr"><div class="stat-date">6/14/2017</div></td>';
            });
            ...
            bodyLines.forEach(function(body, i) {
                ...
                innerHtml += '<td class="chartjs-stat pl"> 2046 </td></tr>';
            });
            innerHtml += '</tbody>';
    ...
    //             showLine: "true",
    //             label: '',
    //             data: [20, 10, 3, 40, 50, 90, 60, 80, 100],
    //             backgroundColor:"rgba(2, 171, 236, 0.25)",
    //             borderWidth:4,
    //             borderColor:"rgba(0,170,237,1)",
    //             pointBorderColor:"#02abec",
    //             pointStyle:'circle',
    //             pointRadius: 4,
    //             pointHoverRadius:8,
        ...
        tooltip: {
            ...
            formatter: function() {
                return '<div class="chart-tooltip-wrapper">'+
                    '<span class="point-date">6/14/2017</span>'+
                    '<span class="point-year">2047</span>'
                '<div>';
            },

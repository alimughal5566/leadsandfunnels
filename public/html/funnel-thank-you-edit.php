                        ...
                        <div class="col-right">
                            <div class="action">
                                <ul class="action__list">
                                    ...
                                    <li class="action__item">
                                        <a href="funnel-add-new-page.php" class="back-link"><span class="icon icon-back ico-caret-up"></span> Back to Thank You Page Options</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="action">
                                    <ul class="action__list">
                                        <li class="action__item action__item_en-logo">
                                            <input class="responder-toggle typ_logo" for="typ_logo" id="typ_logo" name="enlogo"
                        ...
                        <div class="lp-panel__body">
                            <div class="form-thank-you">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" placeholder="Thank You! Sebonix Funnel Version1">
                                </div>
                                <div class="form-group m-0">
                                    <label>http://sebonic-rate-quote.devitclix.com/</label>
                                    <input id="url__text" class="form-control" type="text" placeholder="thank-you">
                                </div>
                            </div>
                        </div>
                    </div>

                        ...
                        <div class="question-option-scroll">
                            <ul class="custom-accordion">
                                <li class="custom-accordion__list">
                                    <a href="#" class="custom-accordion__opener">Most Popular <i class="ico ico-arrow-down"></i></a>
                                    <div class="custom-accordion__slide">
                                        <div class="question-standard">
                                            <ul class="question-option__list">
                                                ...
                                                <li class="question-option__item question-option__item_dropdown el-tooltip" data-icon="icon-text_dropdown" title="<p class='global-tooltip font-small text-uppercase'>Coming Soon!</p>" disabled>drop down</li>
                                ...
                                <li class="custom-accordion__list">
                                    <a href="#" class="custom-accordion__opener">More Questions <i class="ico ico-arrow-down"></i></a>
                                    <div class="custom-accordion__slide">
                                        <div class="question-standard">
                                            <ul class="question-option__list">
                                                <li class="question-option__item question-option__item_address" data-icon="icon-text_address">address</li>
                                                <li class="question-option__item question-option__item_birthday" data-icon="icon-text_birthday">birthday</li>
                                                <li class="question-option__item question-option__item_question-group" data-icon="icon-text_question-group">question group</li>
                                            </ul>
                                        </div>
                                        <div class="question-global">
                                            <div class="placeholder">
                            ...
                            <div class="funnel-panel__head-wrap">
                                ...
                                <ul class="funnel-panel__options">
                                    ...
                                    <li class="funnel-panel__item logic">
                                        <a href="#" data-toggle="modal" data-target="#conditional-logic" class="btn panel-button__btn">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <ul class="btns-list">
                    ...
                    <li>
                        <button type="button" class="button button-primary btn-add-icon disabled">Select</button>
                    </li>
                </ul>
            </div>
        </div>

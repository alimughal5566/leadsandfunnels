...
?>
    <div class="panel-aside">
        <div class="panel-aside__head">
            <div class="col-left">
                <h4 class="panel-aside__title has-icon calander-icon">
                <span>
        ...
        <div class="panel-aside-wrap">
            ...
            <div class="form-group fb-modal__border-box fb-modal__border-box_dropdown">
                ...
                <div class="fb-modal__border-row fb-modal__border-row_menu">
                    <div class="fb-form">
                        <div class="select2js select2js__select-answer_parent">
                            <select class="select2js__select-answer" name="select-answer"></select>
                        </div>
                        <div class="select2js select2js__year-display_parent">
                            <select class="select2js__year-display" name="year-display"></select>
                        </div>
                        <div class="select2js select2js__age-required_parent">
                            <select class="select2js__age-required" name="age-required"></select>
                        </div>
                    </div>
                </div>

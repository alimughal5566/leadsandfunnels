    ...
    <div class="panel-aside">
        ...
        <div class="panel-aside-wrap">
            ...
            <div class="form-group fb-modal__border-box fb-modal__border-box_dropdown">
                ...
                <div class="fb-modal__border-row fb-modal__border-row_menu">
                    <div class="state">
                        <ul class="state__list scroll">
                            <li class="state__name">Alabama</li>
                            <li class="state__name">Alaska</li>
                            <li class="state__name">Arizona</li>
                            <li class="state__name">Arkansas</li>
                            <li class="state__name">California</li>
                            <li class="state__name">Colorado</li>
                            <li class="state__name">Connecticut</li>
                            <li class="state__name">Delaware</li>
                            <li class="state__name">Florida</li>
                            <li class="state__name">Georgia</li>
                            <li class="state__name">Hawaii</li>
                            <li class="state__name">Idaho</li>
                            <li class="state__name">Illinois</li>
                            <li class="state__name">Indiana</li>
                            <li class="state__name">Iowa</li>
                        </ul>
                    </div>
                </div>
            </div>

...
?>
    ...
    <div  id="content">
        ...
        <main class="main">
            <!-- content of the page -->
            <section class="main-content funnel-share funnel-share-advance">
                ...
                <div class="lp-panel">
                    ...
                    <div class="lp-panel__body">
                        <div class="form-group m-0 funnel_url">
                            ...
                            <a href="#" class="form-control link-swatcher el-tooltip" data-container="body" title="SHORTEN URL"><i class="fas fa-exchange-alt"></i></a>
                            <button class="button button-bold button-primary" onclick="copyToClipboard('#funnelUrl')">copy url</button>
                        </div>
                ...
                <div class="lp-panel pb-0">
                    <div class="lp-panel__head">
                        <div class="col-left">
                            <h2 class="lp-panel__title">
                                Social Share Image
                                <span class="question-mark el-tooltip" title="<p>Your Social Share image is what shows when <br>  you share your Funnel link on social media.</p><p>If you don't upload a social share image, <br> we'll automatically pull your Featured Image. <br>If  you don't have a Featured Image, <br> we'll pull your logo.</p><p class='m-0'>If you don't have a logo or a Featured Image, <br> and you don't upload a Social share Image <br> below, no image will be shown when you <br> share your Funnel link.</p>">

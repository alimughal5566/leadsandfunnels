        ...
        submitHandler: function (form) {
            ...
            if (savebottomlinkmessage()) {
                ajaxRequestHandler.submitForm(function (response, isError) {
                    console.log("submit contact us callback...", response, isError);
                });
...
function mytoggledestination() {
    ...
    let globalMode =  parseInt(localStorage.getItem('mode'));
    let theselection = (globalMode)?$(".main").data('global'):$(".main").data('single');
    $('#theselection').val(theselection);
    if (thelink == 'u') {
        $('#theselection').val('u');
        $('#webmodal').hide();
        $('#webaddress').show();
    ...
    switch ($('#linktype').val()) {
        ...
        case 'm':
            ...
            if (editor.core.isEmpty()) {
                ...
                // errormessage( "Please enter or select your html template.");
                error = true;
            }
            break;
        default:

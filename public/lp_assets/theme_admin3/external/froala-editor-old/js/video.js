 ...
 */
var videoElement = ["videoBack", "|", "videoByURL", "videoEmbed", "videoUpload"];
let isiFrame = true;
if(page[3] == 'autoresponder'){
    videoElement = ["videoBack", "|", "videoByURL"];
    isiFrame = false;
}
//custom video url embed html format
var customFormat = {
    html: "<a href='{url}' target='_blank'><img src='https://images.lp-images1.com/default/images/play-icon.png' width='100'></a>",
}
! function(i) {
    ...
    Z.extend(Z.FE.POPUP_TEMPLATES, {
        ...
        videoInsertButtons: videoElement,
      ...
      skip: true,
      test_regex: /(^(https?:\/\/(?:www\.)?|(?:www\.))?|\s(https?:\/\/(?:www\.)?|(?:www\.))?)bbemaildelivery\.com/,
      url_regex: '',
      url_text: '',
      html: '<iframe width="640" height="360" src="{url}" frameborder="0" allowfullscreen scrolling="no"></iframe>',
      provider: 'vid'
            ...
            C("Loading video"),
                function() {
                    ...
                    if (l) {
                        ...
                        if (void 0 !== d)
                            for (t in d) d.hasOwnProperty(t) && "link" != t && e.find("video").attr("data-" + t, d[t]);
                        e.find("video").on("canplay", w), e.find("video").attr("src", a), v.edit.on(), F(), v.undo.saveStep(), v.$el.blur(), v.events.trigger(o ? "video.replaced" : "video.inserted", [e, f])
                    } else e = function(e, t, i) {
                        var o, r = "";
                        if (t && void 0 !== t)
                            for (o in t) t.hasOwnProperty(o) && "link" != o && (r += " data-" + o + '="' + t[o] + '"');
                    ...
                    }(a, d, w), F(), v.undo.saveStep(), v.events.trigger("video.inserted", [e, f])
                }()
        }
        ...
        function B(e) {
            ...
            if (f) {
                ...
                var s = t - o,
                    ...
                    d = a.width(),
                    l = a.height();
                (f.hasClass("fr-hnw") || f.hasClass("fr-hsw")) && (s = 0 - s), (f.hasClass("fr-hnw") || f.hasClass("fr-hne")) && (n = 0 - n), a.css("width", d + s), a.css("height", l + n), a.removeAttr("width"), a.removeAttr("height"), L()
            }
        }
        ...
        function k(e, t, i, o) {
            return e.pageX = t, e.pageY = t, I.call(this, e), e.pageX = e.pageX + i * Math.floor(Math.pow(1.1, o)), e.pageY = e.pageY + i * Math.floor(Math.pow(1.1, o)), B.call(this, e), $.call(this, e), ++o
        }
        ...
        function F() {
            ...
            if (o)
                for (e = 0; e < o.length; e++) i.indexOf(o[e].getAttribute("src")) < 0 && v.events.trigger("video.removed", [Z(o[e])]);
            o = t
        }
        ...
        function L() {
            p || function() {
                ...
                if (v.shared.$video_resizer ? (p = v.shared.$video_resizer, a = v.shared.$vid_overlay, v.events.on("destroy", function() {
                    ...
                    e = p.get(0).ownerDocument, v.events.$on(p, v._mousedown, ".fr-handler", I), v.events.$on(Z(e), v._mousemove, B), v.events.$on(Z(e.defaultView || e.parentWindow), v._mouseup, $), v.events.$on(a, "mouseleave", $);
                    var o = 1,
                        r = null,
                        s = 0;
        ...
        function O(e) {
            ...
            v.toolbar.disable(), v.helpers.isMobile() && (v.events.disableBlur(), v.$el.blur(), v.events.enableBlur()), v.$el.find(".fr-video.fr-active").removeClass("fr-active"), (u = Z(this)).addClass("fr-active"), v.opts.iframe && v.size.syncIframe(), G(), L(), s(), v.selection.clear(), v.button.bulkRefresh(), v.events.trigger("image.hideResizer")
        }
        ...
        function M(e) {
            if (void 0 !== e && 0 < e.length) {
                ...
                var t, i = e[0];
                if (null === v.opts.videoUploadURL || v.opts.videoUploadURL == l) return a = i, (d = new FileReader).addEventListener("load", function() {
                    d.result;
                ...
                if (v.drag_support.formdata && (t = v.drag_support.formdata ? new FormData : null), t) {
                    var o;
                    if (!1 !== v.opts.videoUploadToS3)
                        for (o in t.append("key", v.opts.videoUploadToS3.keyStart + (new Date).getTime() + "-" + (i.name || "untitled")), t.append("success_action_status", "201"), t.append("X-Requested-With", "xhr"), t.append("Content-Type", i.type), v.opts.videoUploadToS3.params) v.opts.videoUploadToS3.params.hasOwnProperty(o) && t.append(o, v.opts.videoUploadToS3.params[o]);
        ...
        function N(e, t) {
            v.edit.on(), u && u.find("video").addClass("fr-error"),
                function(e) {
                    C();
        ...
        return r[1] = "Video cannot be loaded from the passed link.", r[d] = "No link in upload response.", r[c] = "Error during file upload.", r[h] = "Parsing response failed.", r[g] = "File is too large.", r[m] = "Video file type is invalid.", r[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", v.shared.vid_exit_flag = !1, {
            _init: function() {
                v.events.on("drop", T, !0), v.events.on("mousedown window.mousedown", e), v.events.on("window.touchmove", P), v.events.on("mouseup window.mouseup", z), v.events.on("commands.mousedown", function(e) {
            ...
            showInsertPopup: function() {
                ...
                if (t || (t = n()), A(), !t.hasClass("fr-active"))
                    if (v.popups.refresh("video.insert"), v.popups.setContainer("video.insert", v.$tb), e.is(":visible")) {
                ...
                jQuery('#videoUpload-1').next().remove('.bombbombwrapper');
                //jQuery('#videoUpload-1').after('<div class = "bombbombwrapper"><img src="data:image/png;base64,"></div>');
                jQuery('#videoUpload-1').after("<div class='bombbombwrapper'><img src='data:image/png;base64,'><p class= 'bombomb_desc'>If you're adding a BombBomb video, be sure to paste the full-length URL below, not the shortened version.</p></div>");
                jQuery(".bombbombwrapper").hover(function () {
            ...
            insertByURL: function(e) {
                ...
                var t = null;
                if (/^http/.test(e) || (e = "https://" + e), v.helpers.isURL(e))
                    if(isiFrame) {
                        for (var i = 0; i < Z.FE.VIDEO_PROVIDERS.length; i++) {
                       ...
                       t = customFormat.html.replace(/\{url\}/,e);
                    }
            ...
            insert: y,
            align: function(e) {
                u.removeClass("fr-fvr fr-fvl"), !v.opts.htmlUntouched && v.opts.useClasses ? "left" == e ? u.addClass("fr-fvl") : "right" == e && u.addClass("fr-fvr") : W(u, X(), e), G(), L(), s(), v.selection.clear()
            },
            ...
            display: function(e) {
                u.removeClass("fr-dvi fr-dvb"), !v.opts.htmlUntouched && v.opts.useClasses ? "inline" == e ? u.addClass("fr-dvi") : "block" == e && u.addClass("fr-dvb") : W(u, e, H()), G(), L(), s(), v.selection.clear()
            },

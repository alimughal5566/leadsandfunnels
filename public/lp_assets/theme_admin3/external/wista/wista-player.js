...
$(document).ready(function(){
    ...
    $(document.body).on("click",".lp-wistia-video",function(e){
        e.preventDefault();
        //stopvideo();
...
function showlpvideo(title,wistiskey){
    // pausewistiavideos();
    $("#lp-video-modal .modal-dialog .modal-content .modal-header .modal-title").html("<span class='modal-watch-text'>Watch How-To Video:</span>"+" "+title);
    if(wistiskey != '#') {

(function ($) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $.each(data, function (index, el) {
                            ...
                            $("#emmacheckboxes input[type=checkbox]."+el).next().addClass('label-color');
                        });
                    },
                    error: function () {
                        alert("failure");
    ...
    $(document).ready(function() {
        ...
        if( $(".disabled-list").length == 1 ){
            $('.verticals').trigger('click');
            $('.vertical-select-menu').removeClass('open');
        }
    });
})(jQuery);

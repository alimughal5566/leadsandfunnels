...
*/$(document).ready(function(){
    ...
    $("#lp-train-module,#lp-train-module-sup").on("click",function(e){
        ...
        setTimeout(function(){
            ...
            $("."+target_parent).removeClass("hidden").addClass("show");
    ...
    $(".helper_overlay .close_btn").click(function(e){
        ...
        $("#flagoverlay").val(0);
        $("."+$(this).attr("data-ov-target")).removeClass("show").addClass("hidden");
        $('body').css('overflow', '');
    ...
    $(".helper_popup .close_btn").click(function(e){
        ...
        $( "."+ver_parent +" .helper_popup" ).addClass('hidden');
    ...
    $('.lp_read_more').click(function (e) {
        ...
        $("."+ver_parent+" .helper_popup" ).removeClass( "hidden");
    ...
    function _load_detail(parent_ele,r_item,callfor){
        ...
        if(r_item["wistia_id"]){
            ...
            if(ifsrc!=""){
                ...
                //console.log($(".helper_popup .iframe_container .popup-frame")[0].src);
                //$("."+target_parent+" .helper_popup .iframe_container .popup-frame")[0].src += "?autoplay=1";
                $("."+parent_ele+" .helper_popup .iframe_container").html('<img src="'+site.baseUrl+site.lpAssetsPath+'/adminimages/videoph.png" data-ov-target="'+parent_ele+'" data-lp-wistia-title="'+ r_item["title"]+'" data-lp-wistia-key="'+ r_item["wistia_id"]+'" class="lp-sup-video-thumbnail"><iframe class="popup-frame hidden"  src="'+ifsrc+'"  frameborder="1" allowfullscreen></iframe>');
                //$("."+parent_ele+" .helper_popup .iframe_container").html('<img src="'+site.baseUrl+site.lpAssetsPath+'/adminimages/videoph.png" data-ov-target="'+parent_ele+'" data-lp-wistia-title="'+ r_item["title"]+'" data-lp-wistia-key="'+ r_item["wistia_id"]+'" class="lp-sup-video-thumbnail"><iframe class="popup-frame hidden"  src="'+ifsrc+'"  frameborder="1" allowfullscreen></iframe>');
            }else {
        ...
        $("."+parent_ele+' .popup-frame').removeClass('hidden');

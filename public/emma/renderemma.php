...
if ($geaccount) {
	...
	$text .= '</ul>';
	$text .= '<button class="btn btn-success" onClick="window.location.href=window.location.href">Refresh Page</button>';
	$text .= '<button class="btn btn-info float-right btn-info activatestatus" data-id="'.$client_id.'" onclick="activatestatus()">Active Status</button>';
	...
	$text .= '<button type="button" class="btn btn-default btn-md">Refresh</button>';
	print($text);
	return;
}
?>